...
namespace Sample.Data
{
    ...
    /// </summary>
    public partial class RoleManager : EntityManagerBase<SampleDataManager, Role>
    {
        /// <summary>
        ...
        static RoleManager()
        {
            RuleManager.AddShared<Role>(new RequiredRule("RoleName"));
            RuleManager.AddShared<Role>(new LengthRule("RoleName", 50));
            AddRules();
        }
        ...
        public RoleManager(SampleDataManager manager) : base(manager)
        {
            OnCreated();
        }
        ...
        /// </summary>
        public static IEntityKey<int> CreateKey(int roleID)
        {
            return new EntityKey<int>(roleID);
        }
        ...
        public override Role GetByKey(IEntityKey key)
        {
        ...
        public Role GetByKey(int roleID)
        {
            if (Context.LoadOptions == null) 
                return Query.GetByKey.Invoke(Context, roleID);
            else
                return Entity.FirstOrDefault(r => r.RoleID == roleID);
        }
        ...
        private static partial class Query
        {
            ...
            internal static readonly Func<SampleDataContext, int, Role> GetByKey = 
                CompiledQuery.Compile(
                    (SampleDataContext db, int roleID) => 
                        db.Role.FirstOrDefault(r => r.RoleID == roleID));
