...
{
    /// <summary>
    /// The manager class for OrderLine.
    /// </summary>
    public partial class OrderLineManager 
        : CodeSmith.Data.EntityManagerBase<TesterDataManager, Tester.Data.OrderLine>
    {
        /// <summary>
        /// Initializes the <see cref="OrderLineManager"/> class.
        /// </summary>
        static OrderLineManager()
        {
            AddRules();
        }
        ...
        public OrderLineManager(TesterDataManager manager) : base(manager)
        {
            OnCreated();
        }
        ...
        /// </summary>
        protected System.Data.Linq.Table<Tester.Data.OrderLine> Entity
        {
            get { return Manager.Context.OrderLine; }
        }
        ...
        public override Tester.Data.OrderLine GetByKey(CodeSmith.Data.IEntityKey key)
        {
        ...
        public Tester.Data.OrderLine GetByKey(int id)
        {
