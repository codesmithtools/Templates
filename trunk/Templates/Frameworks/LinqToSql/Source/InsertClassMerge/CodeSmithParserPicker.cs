...
{
    public class CodeSmithParserPicker : UITypeEditor
    {
        #region Declarations
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            if (provider != null)
            {
                ...
                if (editorControl != null)
                {
                    ...
                    {
                        CodeSmithParser codeSmithParser = CodeSmithParser.Create(_openFileDialog.FileName);
