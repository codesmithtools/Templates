...
{
    [System.ComponentModel.Editor(typeof(CodeSmithParserPicker), typeof(System.Drawing.Design.UITypeEditor))]
    public class CodeSmithParser : IParser
    {
        #region Static Content

        public static CodeSmithParser Create(string fileName)
        {
            ...
            return new CodeSmithParser(source, language, fileName);
        }
        public static CodeSmithParser Create(string source, SupportedLanguage language)
        {
            return new CodeSmithParser(source, language, String.Empty);
        }
        ...
        protected CodeSmithParser(string source, SupportedLanguage language, string fileName)
        {
            FileName = fileName;
            Language = language;
