...
Namespace NHibVbSample.Generated.Base
	Public Interface INHibernateSessionManager
		...
		' Methods
		Function CreateSession() As INHibernateSession
...
#End Region
		...
		Public Function CreateSession() As INHibernateSession Implements INHibernateSessionManager.CreateSession
...
#End Region
		...
		Public ReadOnly Property Session() As INHibernateSession Implements INHibernateSessionManager.Session
			Get
				Dim cSession As INHibernateSession = ContextSession
