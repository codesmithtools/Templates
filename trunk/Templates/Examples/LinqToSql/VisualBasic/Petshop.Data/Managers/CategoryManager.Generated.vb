...
Namespace Petshop.Data.Managers
	...
	Inherits EntityManagerBase(Of PetshopDataManager,Category)
        ''' <summary>
        ''' Initializes the <see cref="CategoryManager"/> class.
        ''' </summary>
        Shared Sub New()
            RuleManager.AddShared(Of Category)(new RequiredRule("CategoryId"))
            RuleManager.AddShared(Of Category)(new LengthRule("CategoryId", 10))
            RuleManager.AddShared(Of Category)(new LengthRule("Name", 80))
            RuleManager.AddShared(Of Category)(new LengthRule("Descn", 255))
            AddRules()
        End Sub
        ...
        ''' </summary>
        Protected ReadOnly Property Entity As Table(Of Category)
            Get 
        ...
        ''' </summary>
        Public Shared Function CreateKey(categoryId As String) As IEntityKey(Of String)
            Return New EntityKey(Of String)(categoryId)
        End Function
        ...
        Public Overrides Function GetByKey(ByVal key As IEntityKey) As Category
        ...
        Public Overloads Function GetByKey(categoryId As String) As Category
        ...
        Private Partial Class Query
            ...
            Friend Shared Readonly GetByKey As Func(Of PetshopDataContext, String, Category) = _
