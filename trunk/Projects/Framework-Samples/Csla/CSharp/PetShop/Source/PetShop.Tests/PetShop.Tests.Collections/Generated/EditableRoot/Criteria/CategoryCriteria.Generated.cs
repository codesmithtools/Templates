...
namespace PetShop.Tests.Collections.EditableRoot
{
    ...
    public partial class CategoryCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public CategoryCriteria() : base(typeof(PetShop.Tests.Collections.EditableRoot.Category)){}

        public CategoryCriteria(System.String categoryId) : base(typeof(PetShop.Tests.Collections.EditableRoot.Category))
        {
