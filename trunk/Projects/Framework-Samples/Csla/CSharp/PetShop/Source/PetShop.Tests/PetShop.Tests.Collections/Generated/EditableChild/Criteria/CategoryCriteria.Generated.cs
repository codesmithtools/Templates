...
namespace PetShop.Tests.Collections.EditableChild
{
    ...
    public partial class CategoryCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public CategoryCriteria() : base(typeof(PetShop.Tests.Collections.EditableChild.Category)){}

        public CategoryCriteria(System.String categoryId) : base(typeof(PetShop.Tests.Collections.EditableChild.Category))
        {
