...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class CategoryCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public CategoryCriteria() : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Category)){}

        public CategoryCriteria(System.String categoryId) : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Category))
        {
