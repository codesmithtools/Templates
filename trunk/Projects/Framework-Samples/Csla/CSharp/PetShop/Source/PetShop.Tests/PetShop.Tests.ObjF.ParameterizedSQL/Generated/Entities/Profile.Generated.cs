    ...
    public partial class Profile : BusinessBase< Profile >
    {
        ...
        public AccountList Accounts
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.ParameterizedSQL.AccountList.Exists(new PetShop.Tests.ObjF.ParameterizedSQL.AccountCriteria {UniqueID = UniqueID}))
        ...
        public CartList Carts
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.ParameterizedSQL.CartList.Exists(new PetShop.Tests.ObjF.ParameterizedSQL.CartCriteria {UniqueID = UniqueID}))
        ...
        public override bool IsDirty
        {
            get
            {
                ...
                if (Accounts.IsDirty) return true;
                if (Carts.IsDirty) return true;
