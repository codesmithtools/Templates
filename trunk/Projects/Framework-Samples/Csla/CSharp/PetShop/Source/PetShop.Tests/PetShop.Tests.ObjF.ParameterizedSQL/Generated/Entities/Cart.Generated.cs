    ...
    public partial class Cart : BusinessBase< Cart >
    {
        ...
        public Profile ProfileMember
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.ParameterizedSQL.Profile.Exists(new PetShop.Tests.ObjF.ParameterizedSQL.ProfileCriteria {UniqueID = UniqueID}))
                        LoadProperty(_profileMemberProperty, PetShop.Tests.ObjF.ParameterizedSQL.Profile.NewProfile());
                    else
