...
namespace PetShop.Tests.ParameterizedSQL
{
    public partial class Item
    {
        ...
        private void DataPortal_Fetch(ItemCriteria criteria)
        {
            ...
            string commandText = string.Format("SELECT [ItemId], [ProductId], [ListPrice], [UnitCost], [Supplier], [Status], [Name], [Image], [timestamp] FROM [dbo].[Item] {0}", ADOHelper.BuildWhereStatement(criteria.StateBag));
        ...
        protected override void DataPortal_Insert()
        {
            ...
            const string commandText = "INSERT INTO [dbo].[Item] ([ItemId], [ProductId], [ListPrice], [UnitCost], [Supplier], [Status], [Name], [Image]) VALUES (@p_ItemId, @p_ProductId, @p_ListPrice, @p_UnitCost, @p_Supplier, @p_Status, @p_Name, @p_Image); SELECT [timestamp] FROM [dbo].[Item] WHERE ItemId = @p_ItemId";
            using (SqlConnection connection = new SqlConnection(ADOHelper.ConnectionString))
            {
                connection.Open();
                using(SqlCommand command = new SqlCommand(commandText, connection))
                {
					...
					command.Parameters.AddWithValue("@p_ListPrice", this.ListPrice);
					command.Parameters.AddWithValue("@p_UnitCost", this.UnitCost);
					command.Parameters.AddWithValue("@p_Supplier", this.Supplier);
        ...
        protected override void DataPortal_Update()
        {
            ...
            const string commandText = "UPDATE [dbo].[Item]  SET [ItemId] = @p_ItemId, [ProductId] = @p_ProductId, [ListPrice] = @p_ListPrice, [UnitCost] = @p_UnitCost, [Supplier] = @p_Supplier, [Status] = @p_Status, [Name] = @p_Name, [Image] = @p_Image WHERE [ItemId] = @p_OriginalItemId AND [timestamp] = @p_timestamp; SELECT [timestamp] FROM [dbo].[Item] WHERE ItemId = @p_ItemId";
            using (SqlConnection connection = new SqlConnection(ADOHelper.ConnectionString))
            {
                connection.Open();
                using(SqlCommand command = new SqlCommand(commandText, connection))
        ...
        private void Map(SafeDataReader reader)
        {
            ...
            using(BypassPropertyChecks)
            {
                ...
                LoadProperty(_originalItemIdProperty, reader.GetString("ItemId"));
