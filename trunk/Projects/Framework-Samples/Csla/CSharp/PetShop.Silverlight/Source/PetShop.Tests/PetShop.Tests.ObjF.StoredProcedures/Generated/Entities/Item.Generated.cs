    ...
    public partial class Item : BusinessBase< Item >
    {
        ...
        public Product ProductMember
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.StoredProcedures.Product.Exists(new PetShop.Tests.ObjF.StoredProcedures.ProductCriteria {ProductId = ProductId}))
                        LoadProperty(_productMemberProperty, PetShop.Tests.ObjF.StoredProcedures.Product.NewProduct());
                    else
        ...
        public Supplier SupplierMember
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.StoredProcedures.Supplier.Exists(new PetShop.Tests.ObjF.StoredProcedures.SupplierCriteria {SuppId = Supplier.Value}))
                        LoadProperty(_supplierMemberProperty, PetShop.Tests.ObjF.StoredProcedures.Supplier.NewSupplier());
                    else
