            ...
            get
            {
                if(!FieldManager.FieldExists(_categoryMemberProperty))
                {
                    ...
                    if(PetShop.Business.Category.Exists(criteria))
                        PetShop.Business.Category.GetByCategoryIdAsync(CategoryId, (o, e) =>
                            {
                                if (e.Error != null)
                                    throw e.Error; 

                                this.LoadProperty(_categoryMemberProperty, e.Object);
            ...
            get
            {
                if(!FieldManager.FieldExists(_itemsProperty))
                {
                    ...
                    if(IsNew || !PetShop.Business.ItemList.Exists(criteria))
                        ...
                        PetShop.Business.ItemList.GetByProductIdAsync(ProductId, (o, e) =>
                            {
                                if (e.Error != null)
                                    throw e.Error; 
