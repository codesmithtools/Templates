...
Namespace PetShop.Tests.Collections.EditableChild
    ...
    Public Partial Class CategoryList 
        Inherits BusinessListBase(Of CategoryList, CategoryList)
        ...
        Protected Overrides Function AddNewCore() As Object
            Dim item As CategoryList = PetShop.Tests.Collections.EditableChild.CategoryList.NewCategoryList()
            ...
            If Not (cancel) Then
                ...
                If(item Is Nothing) Then
                    item = PetShop.Tests.Collections.EditableChild.CategoryList.NewCategoryList()
                End If
                Add(item)
            End If
