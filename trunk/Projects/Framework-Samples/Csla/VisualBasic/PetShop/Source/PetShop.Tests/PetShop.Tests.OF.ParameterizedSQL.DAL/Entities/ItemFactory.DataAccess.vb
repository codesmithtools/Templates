...
Public Partial Class ItemFactory
    ...
    Private Sub DoUpdate(ByRef item As Item, ByVal stopProccessingChildren As Boolean)
        ...
        If (item.IsDirty) Then
            ...
            Const commandText As String = "UPDATE [dbo].[Item]  SET [ItemId] = @p_ItemId, [ProductId] = @p_ProductId, [ListPrice] = @p_ListPrice, [UnitCost] = @p_UnitCost, [Supplier] = @p_Supplier, [Status] = @p_Status, [Name] = @p_Name, [Image] = @p_Image WHERE [ItemId] = @p_ItemId AND [timestamp] = @p_timestamp; SELECT [timestamp] FROM [dbo].[Item] WHERE ItemId = @p_ItemId"
            Using connection As New SqlConnection(ADOHelper.ConnectionString)
                connection.Open()
                Using command As New SqlCommand(commandText, connection)
