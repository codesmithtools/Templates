...
Namespace PetShop.Tests.OF.StoredProcedures
    ...
    Public Partial Class Item 
        ...
        Private Shared ReadOnly _listPriceProperty As PropertyInfo(Of System.Nullable(Of System.Decimal)) = RegisterProperty(Of System.Nullable(Of System.Decimal))(Function(p As Item) p.ListPrice, String.Empty, Nothing)
        ...
        Private Shared ReadOnly _unitCostProperty As PropertyInfo(Of System.Nullable(Of System.Decimal)) = RegisterProperty(Of System.Nullable(Of System.Decimal))(Function(p As Item) p.UnitCost, String.Empty, Nothing)
        ...
        Private Shared ReadOnly _supplierProperty As PropertyInfo(Of System.Nullable(Of System.Int32)) = RegisterProperty(Of System.Nullable(Of System.Int32))(Function(p As Item) p.Supplier, String.Empty, Nothing)
        ...
        Public ReadOnly Property ProductMember() As Product
            Get
                If Not(FieldManager.FieldExists(_productMemberProperty))
                    Dim criteria As New PetShop.Tests.OF.StoredProcedures.ProductCriteria()
                    criteria.ProductId = ProductId
    
                    If (Me.IsNew OrElse Not PetShop.Tests.OF.StoredProcedures.Product.Exists(criteria)) Then
                        LoadProperty(_productMemberProperty, PetShop.Tests.OF.StoredProcedures.Product.NewProduct())
                    Else
                        LoadProperty(_productMemberProperty, PetShop.Tests.OF.StoredProcedures.Product.GetByProductId(ProductId))
                    End If
                End If
        ...
        Public ReadOnly Property SupplierMember() As Supplier
            Get
                If Not(FieldManager.FieldExists(_supplierMemberProperty))
                    Dim criteria As New PetShop.Tests.OF.StoredProcedures.SupplierCriteria()
                    If(Supplier.HasValue) Then criteria.SuppId = Supplier.Value
    
                    If (Me.IsNew OrElse (Not Supplier.HasValue) OrElse Not PetShop.Tests.OF.StoredProcedures.Supplier.Exists(criteria)) Then
                        LoadProperty(_supplierMemberProperty, PetShop.Tests.OF.StoredProcedures.Supplier.NewSupplier())
                    Else
                        LoadProperty(_supplierMemberProperty, PetShop.Tests.OF.StoredProcedures.Supplier.GetBySuppId(Supplier.Value))
                    End If
                End If
