...
Public Partial Class Item
    ...
    Private Shadows Sub DataPortal_Fetch(ByVal criteria As ItemCriteria )
        ...
        Dim commandText As String = String.Format("SELECT [ItemId], [ProductId], [ListPrice], [UnitCost], [Supplier], [Status], [Name], [Image], [timestamp] FROM [dbo].[Item] {0}", ADOHelper.BuildWhereStatement(criteria.StateBag))
    ...
    Protected Overrides Sub DataPortal_Insert()
        ...
        Const commandText As String = "INSERT INTO [dbo].[Item] ([ItemId], [ProductId], [ListPrice], [UnitCost], [Supplier], [Status], [Name], [Image]) VALUES (@p_ItemId, @p_ProductId, @p_ListPrice, @p_UnitCost, @p_Supplier, @p_Status, @p_Name, @p_Image); SELECT [timestamp] FROM [dbo].[Item] WHERE ItemId = @p_ItemId"
        Using connection As New SqlConnection(ADOHelper.ConnectionString)
            connection.Open()
            Using command As New SqlCommand(commandText, connection)
    ...
    Protected Overrides Sub DataPortal_Update()
        ...
        Const commandText As String = "UPDATE [dbo].[Item]  SET [ItemId] = @p_ItemId, [ProductId] = @p_ProductId, [ListPrice] = @p_ListPrice, [UnitCost] = @p_UnitCost, [Supplier] = @p_Supplier, [Status] = @p_Status, [Name] = @p_Name, [Image] = @p_Image WHERE [ItemId] = @p_OriginalItemId AND [timestamp] = @p_timestamp; SELECT [timestamp] FROM [dbo].[Item] WHERE ItemId = @p_ItemId"
        Using connection As New SqlConnection(ADOHelper.ConnectionString)
            connection.Open()
            Using command As New SqlCommand(commandText, connection)
