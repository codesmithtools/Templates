...
Public Partial Class LineItem
    ...
    Protected Overrides Sub DataPortal_Update()
        ...
        Const commandText As String = "UPDATE [dbo].[LineItem]  SET [OrderId] = @p_OrderId, [LineNum] = @p_LineNum, [ItemId] = @p_ItemId, [Quantity] = @p_Quantity, [UnitPrice] = @p_UnitPrice WHERE [OrderId] = @p_OriginalOrderId AND [LineNum] = @p_OriginalLineNum AND [timestamp] = @p_timestamp; SELECT [timestamp] FROM [dbo].[LineItem] WHERE OrderId = @p_OrderId"
        Using connection As New SqlConnection(ADOHelper.ConnectionString)
            connection.Open()
            Using command As New SqlCommand(commandText, connection)
