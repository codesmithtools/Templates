...
#Region "Method Overrides"
        ...
        Protected Overrides Function AddNewCore() As Supplier
            Dim item As Supplier = PetShop.Tests.OF.StoredProcedures.Supplier.NewSupplier()
            ...
            If Not (cancel) Then
                ...
                If(item Is Nothing) Then
                    item = PetShop.Tests.OF.StoredProcedures.Supplier.NewSupplier()
                End If
                Add(item)
            End If
...
#Region "Exists Command"
        ...
        Public Shared Function Exists(ByVal criteria As SupplierCriteria) As Boolean
            Return PetShop.Tests.OF.StoredProcedures.Supplier.Exists(criteria)
        End Function
