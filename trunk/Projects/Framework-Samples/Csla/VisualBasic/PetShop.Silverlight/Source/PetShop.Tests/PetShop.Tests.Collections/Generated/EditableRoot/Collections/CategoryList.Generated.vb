...
Namespace PetShop.Tests.Collections.EditableRoot
    ...
    Public Partial Class CategoryList 
        ...
        Protected Overrides Function AddNewCore() As Object
            Dim item As CategoryList = PetShop.Tests.Collections.EditableRoot.CategoryList.NewCategoryList()
            ...
            If Not (cancel) Then
                ...
                If(item Is Nothing) Then
                    item = PetShop.Tests.Collections.EditableRoot.CategoryList.NewCategoryList()
                End If
                Add(item)
            End If
