...
Namespace Tracker.Core.Data
    ...
    <System.ComponentModel.DataAnnotations.MetadataType(GetType(User.Metadata))> _
...
#Region "Static Constructor"
        ...
        ''' </summary>
        Shared Sub New()
            CodeSmith.Data.Rules.RuleManager.AddShared(Of User)()
            AddSharedRules()
        End Sub
#End Region
...
#Region "Clone"
        ...
        Public Function Clone() As User
            Return DirectCast(DirectCast(Me, ICloneable), User).Clone()
        End Function
#End Region
