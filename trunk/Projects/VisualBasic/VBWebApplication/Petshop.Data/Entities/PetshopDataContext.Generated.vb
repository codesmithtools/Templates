...
Namespace Petshop.Data
    ...
    public Partial Class PetshopDataContext 
        ...
        public ReadOnly Property Account As System.Data.Linq.Table(Of Petshop.Data.Account)
            Get
                Return GetTable(Of Petshop.Data.Account)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Cart table in the underlying database.</summary>
        public ReadOnly Property Cart As System.Data.Linq.Table(Of Petshop.Data.Cart)
            Get
                Return GetTable(Of Petshop.Data.Cart)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Category table in the underlying database.</summary>
        public ReadOnly Property Category As System.Data.Linq.Table(Of Petshop.Data.Category)
            Get
                Return GetTable(Of Petshop.Data.Category)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Inventory table in the underlying database.</summary>
        public ReadOnly Property Inventory As System.Data.Linq.Table(Of Petshop.Data.Inventory)
            Get
                Return GetTable(Of Petshop.Data.Inventory)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Item table in the underlying database.</summary>
        public ReadOnly Property Item As System.Data.Linq.Table(Of Petshop.Data.Item)
            Get
                Return GetTable(Of Petshop.Data.Item)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.LineItem table in the underlying database.</summary>
        public ReadOnly Property LineItem As System.Data.Linq.Table(Of Petshop.Data.LineItem)
            Get
                Return GetTable(Of Petshop.Data.LineItem)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Orders table in the underlying database.</summary>
        public ReadOnly Property Orders As System.Data.Linq.Table(Of Petshop.Data.Orders)
            Get
                Return GetTable(Of Petshop.Data.Orders)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.OrderStatus table in the underlying database.</summary>
        public ReadOnly Property OrderStatus As System.Data.Linq.Table(Of Petshop.Data.OrderStatus)
            Get
                Return GetTable(Of Petshop.Data.OrderStatus)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Product table in the underlying database.</summary>
        public ReadOnly Property Product As System.Data.Linq.Table(Of Petshop.Data.Product)
            Get
                Return GetTable(Of Petshop.Data.Product)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Profiles table in the underlying database.</summary>
        public ReadOnly Property Profiles As System.Data.Linq.Table(Of Petshop.Data.Profiles)
            Get
                Return GetTable(Of Petshop.Data.Profiles)()
            End Get
        End Property
        
        ''' <summary>Represents the dbo.Supplier table in the underlying database.</summary>
        public ReadOnly Property Supplier As System.Data.Linq.Table(Of Petshop.Data.Supplier)
            Get
                Return GetTable(Of Petshop.Data.Supplier)()
            End Get
        End Property
        ...
        Partial Private Sub InsertAccount(ByVal instance As Petshop.Data.Account)
        End Sub
        ''' <summary>Called before a Account is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateAccount(ByVal instance As Petshop.Data.Account)
        End Sub
        ''' <summary>Called before a Account is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteAccount(ByVal instance As Petshop.Data.Account)
        End Sub
        ''' <summary>Called before a Cart is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertCart(ByVal instance As Petshop.Data.Cart)
        End Sub
        ''' <summary>Called before a Cart is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateCart(ByVal instance As Petshop.Data.Cart)
        End Sub
        ''' <summary>Called before a Cart is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteCart(ByVal instance As Petshop.Data.Cart)
        End Sub
        ''' <summary>Called before a Category is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertCategory(ByVal instance As Petshop.Data.Category)
        End Sub
        ''' <summary>Called before a Category is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateCategory(ByVal instance As Petshop.Data.Category)
        End Sub
        ''' <summary>Called before a Category is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteCategory(ByVal instance As Petshop.Data.Category)
        End Sub
        ''' <summary>Called before a Inventory is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertInventory(ByVal instance As Petshop.Data.Inventory)
        End Sub
        ''' <summary>Called before a Inventory is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateInventory(ByVal instance As Petshop.Data.Inventory)
        End Sub
        ''' <summary>Called before a Inventory is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteInventory(ByVal instance As Petshop.Data.Inventory)
        End Sub
        ''' <summary>Called before a Item is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertItem(ByVal instance As Petshop.Data.Item)
        End Sub
        ''' <summary>Called before a Item is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateItem(ByVal instance As Petshop.Data.Item)
        End Sub
        ''' <summary>Called before a Item is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteItem(ByVal instance As Petshop.Data.Item)
        End Sub
        ''' <summary>Called before a LineItem is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertLineItem(ByVal instance As Petshop.Data.LineItem)
        End Sub
        ''' <summary>Called before a LineItem is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateLineItem(ByVal instance As Petshop.Data.LineItem)
        End Sub
        ''' <summary>Called before a LineItem is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteLineItem(ByVal instance As Petshop.Data.LineItem)
        End Sub
        ''' <summary>Called before a Orders is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertOrders(ByVal instance As Petshop.Data.Orders)
        End Sub
        ''' <summary>Called before a Orders is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateOrders(ByVal instance As Petshop.Data.Orders)
        End Sub
        ''' <summary>Called before a Orders is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteOrders(ByVal instance As Petshop.Data.Orders)
        End Sub
        ''' <summary>Called before a OrderStatus is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertOrderStatus(ByVal instance As Petshop.Data.OrderStatus)
        End Sub
        ''' <summary>Called before a OrderStatus is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateOrderStatus(ByVal instance As Petshop.Data.OrderStatus)
        End Sub
        ''' <summary>Called before a OrderStatus is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteOrderStatus(ByVal instance As Petshop.Data.OrderStatus)
        End Sub
        ''' <summary>Called before a Product is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertProduct(ByVal instance As Petshop.Data.Product)
        End Sub
        ''' <summary>Called before a Product is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateProduct(ByVal instance As Petshop.Data.Product)
        End Sub
        ''' <summary>Called before a Product is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteProduct(ByVal instance As Petshop.Data.Product)
        End Sub
        ''' <summary>Called before a Profiles is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertProfiles(ByVal instance As Petshop.Data.Profiles)
        End Sub
        ''' <summary>Called before a Profiles is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateProfiles(ByVal instance As Petshop.Data.Profiles)
        End Sub
        ''' <summary>Called before a Profiles is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteProfiles(ByVal instance As Petshop.Data.Profiles)
        End Sub
        ''' <summary>Called before a Supplier is inserted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub InsertSupplier(ByVal instance As Petshop.Data.Supplier)
        End Sub
        ''' <summary>Called before a Supplier is updated.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub UpdateSupplier(ByVal instance As Petshop.Data.Supplier)
        End Sub
        ''' <summary>Called before a Supplier is deleted.</summary>
        ''' <param name="instance">The instance.</param>
        Partial Private Sub DeleteSupplier(ByVal instance As Petshop.Data.Supplier)
        End Sub
        #End Region
        ...
        Private _auditingEnabled As Boolean = False
