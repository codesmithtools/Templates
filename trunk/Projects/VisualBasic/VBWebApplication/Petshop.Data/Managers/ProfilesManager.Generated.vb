...
Namespace Petshop.Data
    ...
    Partial Public Class ProfilesManager 
        Inherits CodeSmith.Data.EntityManagerBase(Of PetshopDataManager, Petshop.Data.Profiles)
        ...
        ''' </summary>
        Protected ReadOnly Property Entity() As System.Data.Linq.Table(Of Petshop.Data.Profiles)
            Get 
        ...
        ''' </summary>
        Public Shared Function CreateKey(ByVal uniqueID As Integer) As CodeSmith.Data.IEntityKey(Of Integer)
            Return New CodeSmith.Data.EntityKey(Of Integer)(uniqueID)
        End Function
        ...
        Public Overrides Function GetByKey(ByVal key As CodeSmith.Data.IEntityKey) As Petshop.Data.Profiles
        ...
        Public Overloads Function GetByKey(ByVal uniqueID As Integer) As Petshop.Data.Profiles
        ...
        Public Function Delete(ByVal uniqueID As Integer) As Integer
            return Entity.Delete(Function(p)p.UniqueID = uniqueID)
        End Function
        ...
        ''' </summary>
        ''' <returns>An instance of the entity or null if not found.</returns>
        Public Overloads Function GetByUsernameApplicationName(ByVal username As String, ByVal applicationName As String) As Petshop.Data.Profiles
            If (Context.LoadOptions Is Nothing) Then 
        ...
        Private Partial Class Query
            ...
            Friend Shared Readonly GetByKey As Func(Of Petshop.Data.PetshopDataContext, Integer, Petshop.Data.Profiles) = _
            ...
            Friend Shared Readonly GetByUsernameApplicationName As Func(Of Petshop.Data.PetshopDataContext, String, String, Petshop.Data.Profiles) = _
                CompiledQuery.Compile( _
                     Function(db As Petshop.Data.PetshopDataContext, ByVal username As String, ByVal applicationName As String) _
