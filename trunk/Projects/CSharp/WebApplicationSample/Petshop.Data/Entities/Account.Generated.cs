...
namespace Petshop.Data
{
        ...
        : LinqEntityBase, ICloneable
    {
        ...
        {
            _profiles = default(System.Data.Linq.EntityRef<Profiles>);
            OnCreated();
        }
        #endregion
        ...
        private System.Data.Linq.EntityRef<Profiles> _profiles;

        /// <summary>
        /// Gets or sets the Profiles association.
        /// </summary>
        [System.Data.Linq.Mapping.Association(Name = "Profiles_Account", Storage = "_profiles", ThisKey = "UniqueID", OtherKey = "UniqueID", IsUnique = true, IsForeignKey = true, DeleteOnNull = true, DeleteRule = "CASCADE")]
        [System.Runtime.Serialization.DataMember(Order = 13, EmitDefaultValue = false)]
        public Profiles Profiles
        {
            get { return (serializing && !_profiles.HasLoadedOrAssignedValue) ? null : _profiles.Entity; }
            set
            {
                Profiles previousValue = _profiles.Entity;
                if (previousValue != value || _profiles.HasLoadedOrAssignedValue == false)
                {
                    OnProfilesChanging(value);
        ...
        /// <summary>Called when <see cref="Profiles"/> is changing.</summary>
        /// <param name="value">The new value.</param>
        partial void OnProfilesChanging(Profiles value);
        /// <summary>Called after <see cref="Profiles"/> has Changed.</summary>
        partial void OnProfilesChanged();
