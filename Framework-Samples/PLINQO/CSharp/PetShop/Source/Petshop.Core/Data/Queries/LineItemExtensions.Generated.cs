...
namespace PetShop.Core.Data
{
    ...
    public static partial class LineItemExtensions
    {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.LineItem> ByOrderId(this IQueryable<PetShop.Core.Data.LineItem> queryable, ComparisonOperator comparisonOperator, int orderId)
        {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.LineItem> ByLineNum(this IQueryable<PetShop.Core.Data.LineItem> queryable, ComparisonOperator comparisonOperator, int lineNum)
        {
            switch (comparisonOperator)
            {
                case ComparisonOperator.GreaterThan:
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.LineItem> ByItemId(this IQueryable<PetShop.Core.Data.LineItem> queryable, ContainmentOperator containmentOperator, string itemId)
        {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.LineItem> ByQuantity(this IQueryable<PetShop.Core.Data.LineItem> queryable, ComparisonOperator comparisonOperator, int quantity)
        {
            switch (comparisonOperator)
            {
                case ComparisonOperator.GreaterThan:
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.LineItem> ByUnitPrice(this IQueryable<PetShop.Core.Data.LineItem> queryable, ComparisonOperator comparisonOperator, decimal unitPrice)
        {
            switch (comparisonOperator)
            {
                case ComparisonOperator.GreaterThan:
