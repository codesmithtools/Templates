...
namespace PetShop.Core.Data
{
    ...
    public static partial class CategoryExtensions
    {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.Category> ByCategoryId(this IQueryable<PetShop.Core.Data.Category> queryable, ContainmentOperator containmentOperator, string categoryId)
        {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.Category> ByName(this IQueryable<PetShop.Core.Data.Category> queryable, ContainmentOperator containmentOperator, string name)
        {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.Category> ByDescn(this IQueryable<PetShop.Core.Data.Category> queryable, ContainmentOperator containmentOperator, string descn)
        {
