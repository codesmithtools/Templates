...
namespace PetShop.Core.Data
{
    ...
    public static partial class OrderStatusExtensions
    {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.OrderStatus> ByOrderId(this IQueryable<PetShop.Core.Data.OrderStatus> queryable, ComparisonOperator comparisonOperator, int orderId)
        {
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.OrderStatus> ByLineNum(this IQueryable<PetShop.Core.Data.OrderStatus> queryable, ComparisonOperator comparisonOperator, int lineNum)
        {
            switch (comparisonOperator)
            {
                case ComparisonOperator.GreaterThan:
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.OrderStatus> ByTimestamp(this IQueryable<PetShop.Core.Data.OrderStatus> queryable, ComparisonOperator comparisonOperator, System.DateTime timestamp)
        {
            switch (comparisonOperator)
            {
                case ComparisonOperator.GreaterThan:
        ...
        /// <returns><see cref="IQueryable"/> with additional where clause.</returns>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "6.0.0.0")]
        public static IQueryable<PetShop.Core.Data.OrderStatus> ByStatus(this IQueryable<PetShop.Core.Data.OrderStatus> queryable, ContainmentOperator containmentOperator, string status)
        {
