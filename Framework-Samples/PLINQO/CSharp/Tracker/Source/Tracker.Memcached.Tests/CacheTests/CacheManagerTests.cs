...
{
    [TestFixture]
    public class CacheManagerTests : MemcachedTestBase
    {
        [Test]
        public void InvalidKeyTest()
        {
            ...
            object o = CacheManager.Get("number");
            Assert.IsNull(o);
        }
        ...
        {
            bool success = CacheManager.Exists("number");
            Assert.IsFalse(success);

            CacheManager.Set("number", 12);
            success = CacheManager.Exists("number");
