...
namespace PetShop.Business
{
    ...
    {
        /// <summary>
        /// Instantiates a CSLA editable child business object of type <see cref="Cart"/>. 
        /// </summary>
        [RunLocal()]
        ...
        ///    CSLA editable child business object of type <see cref="Cart"/> 
        /// </summary>
        /// <returns></returns>
        ...
        {
            bool cancel = false;
            OnChildInserting(profile, connection, ref cancel);
            if (cancel) return;
        ...
        {
            bool cancel = false;
            OnChildUpdating(profile, connection, ref cancel);
            if (cancel) return;
