            ...
            get
            {
                ...
                if (!cancel)
                {
                    if(!FieldManager.FieldExists(_lineItemsProperty))
                    {
                        ...
                        if((true))
                        {
                            PetShop.Business.LineItemList.ExistsAsync(criteria).ContinueWith(t =>
                            {
                                if (!t.Result)
                                {
                                    PetShop.Business.LineItemList.NewListAsync().ContinueWith(i =>
                                    {
                                        this.LoadProperty(_lineItemsProperty, i.Result);
                                ...
                                {
                                    PetShop.Business.LineItemList.GetByOrderIdAsync(OrderId).ContinueWith(i =>
                                    {
                                        this.LoadProperty(_lineItemsProperty, i.Result);
            ...
            get
            {
                ...
                if (!cancel)
                {
                    if(!FieldManager.FieldExists(_orderStatusesProperty))
                    {
                        ...
                        if((true))
                        {
                            PetShop.Business.OrderStatusList.ExistsAsync(criteria).ContinueWith(t =>
                            {
                                if (!t.Result)
                                {
                                    PetShop.Business.OrderStatusList.NewListAsync().ContinueWith(i =>
                                    {
                                        this.LoadProperty(_orderStatusesProperty, i.Result);
                                ...
                                {
                                    PetShop.Business.OrderStatusList.GetByOrderIdAsync(OrderId).ContinueWith(i =>
                                    {
                                        this.LoadProperty(_orderStatusesProperty, i.Result);
