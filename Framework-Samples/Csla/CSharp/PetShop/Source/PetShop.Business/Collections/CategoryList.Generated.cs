...
namespace PetShop.Business
{
    ...
    {    
        ...
        {
            Category item = PetShop.Business.Category.NewCategoryChild();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Business.Category.NewCategoryChild();
        ...
        {
            PetShop.Business.Category.NewCategoryChildAsync().ContinueWith(t => 
            {
        ...
        public static async Task<CategoryList> NewListAsync()
        {
            return await DataPortal.CreateAsync<CategoryList>();
        }


        public static async Task<CategoryList> GetByCategoryIdAsync(System.String categoryId)
        {
            var criteria = new CategoryCriteria{CategoryId = categoryId};
        ...
        public static async Task<CategoryList> GetAllAsync()
        {
            return await DataPortal.FetchAsync<CategoryList>(new CategoryCriteria());
        }
