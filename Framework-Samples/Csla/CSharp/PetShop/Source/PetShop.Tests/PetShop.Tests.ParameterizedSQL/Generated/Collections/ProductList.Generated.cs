...
namespace PetShop.Tests.ParameterizedSQL
{
    ...
    public partial class ProductList : BusinessListBase<ProductList, Product>
    {
        ...
        internal static async Task<ProductList> NewListAsync()
        {
        ...
        internal static async Task<ProductList> GetByCategoryIdAsync(System.String categoryId)
        {
            var criteria = new ProductCriteria{CategoryId = categoryId};
        ...
        internal static async Task<ProductList> GetByNameAsync(System.String name)
        {
            var criteria = new ProductCriteria{Name = name};
        ...
        internal static async Task<ProductList> GetByCategoryIdNameAsync(System.String categoryId, System.String name)
        {
            var criteria = new ProductCriteria{CategoryId = categoryId, Name = name};
        ...
        internal static async Task<ProductList> GetAllAsync()
        {
            return await DataPortal.FetchAsync<AsyncChildLoader<ProductList>>(new ProductCriteria()).ContinueWith(t => t.Result.Child);
        }
        ...
        protected async Task<Product> AddNewCoreAsync()
        {
            return await PetShop.Tests.ParameterizedSQL.Product.NewProductChildAsync().ContinueWith(t => 
            {
