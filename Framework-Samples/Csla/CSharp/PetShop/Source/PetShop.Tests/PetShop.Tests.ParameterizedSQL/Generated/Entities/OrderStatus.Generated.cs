...
namespace PetShop.Tests.ParameterizedSQL
{
    ...
    public partial class OrderStatus : BusinessBase<OrderStatus>
    {
        ...
        internal static void NewOrderStatusAsync(EventHandler<DataPortalResult<OrderStatus>> handler)
        {
        ...
        internal static void GetByOrderIdLineNumAsync(System.Int32 orderId, System.Int32 lineNum, EventHandler<DataPortalResult<AsyncChildLoader<OrderStatus>>> handler)
        {
            var criteria = new OrderStatusCriteria{ OrderId = orderId, LineNum = lineNum};
            

            DataPortal.BeginFetch<AsyncChildLoader<OrderStatus>>(criteria, handler);
        }

        internal static void GetByOrderIdAsync(System.Int32 orderId, EventHandler<DataPortalResult<AsyncChildLoader<OrderStatus>>> handler)
        {
            var criteria = new OrderStatusCriteria{ OrderId = orderId};
