...
namespace PetShop.Tests.ParameterizedSQL
{
    ...
    {    
        ...
        public static async Task<OrderStatusList> NewListAsync()
        {
            return await DataPortal.CreateAsync<OrderStatusList>();
        }


        public static async Task<OrderStatusList> GetByOrderIdLineNumAsync(System.Int32 orderId, System.Int32 lineNum)
        {
            var criteria = new OrderStatusCriteria{OrderId = orderId, LineNum = lineNum};
            
            
            return await DataPortal.FetchAsync<OrderStatusList>(criteria);
        }

        public static async Task<OrderStatusList> GetByOrderIdAsync(System.Int32 orderId)
        {
            var criteria = new OrderStatusCriteria{OrderId = orderId};
        ...
        public static async Task<OrderStatusList> GetByCriteriaAsync(OrderStatusCriteria criteria)
        {  
            return await DataPortal.FetchAsync<OrderStatusList>(criteria);
        }

        public static async Task<OrderStatusList> GetAllAsync()
        {
            return await DataPortal.FetchAsync<OrderStatusList>(new OrderStatusCriteria());
        }
