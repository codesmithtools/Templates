...
namespace PetShop.Tests.ParameterizedSQL
{
    ...
    {    
        ...
        public static void NewListAsync(EventHandler<DataPortalResult<OrderList>> handler)
        {
        ...
        public static void GetByOrderIdAsync(System.Int32 orderId, EventHandler<DataPortalResult<OrderList>> handler)
        {
            var criteria = new OrderCriteria{OrderId = orderId};
        ...
        public static void GetByCriteriaAsync(OrderCriteria criteria, EventHandler<DataPortalResult<OrderList>> handler)
        {  
            var dp = new DataPortal<OrderList>();
            dp.FetchCompleted += handler;
            dp.BeginFetch(criteria);
        ...
        public static void GetAllAsync(EventHandler<DataPortalResult<OrderList>> handler)
        {
            var dp = new DataPortal<OrderList>();
            dp.FetchCompleted += handler;
            dp.BeginFetch(new OrderCriteria());
        }
        ...
        {
            PetShop.Tests.ParameterizedSQL.Order.ExistsAsync(criteria,handler);
        }
