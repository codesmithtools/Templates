...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class AccountCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public AccountCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Account)){}

        public AccountCriteria(System.Int32 accountId) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Account))
        {
            AccountId = accountId;
        }
