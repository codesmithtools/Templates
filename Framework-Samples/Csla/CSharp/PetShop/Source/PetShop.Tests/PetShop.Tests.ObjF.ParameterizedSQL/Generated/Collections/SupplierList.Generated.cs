...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class SupplierList : BusinessListBase<SupplierList, Supplier>
    {
        ...
        {
            Supplier item = PetShop.Tests.ObjF.ParameterizedSQL.Supplier.NewSupplier();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Tests.ObjF.ParameterizedSQL.Supplier.NewSupplier();
        ...
        {
            return await PetShop.Tests.ObjF.ParameterizedSQL.Supplier.NewSupplierAsync().ContinueWith(t => 
            {
