    ...
    public partial class Item : BusinessBase<Item>
    {
                ...
                if (!cancel)
                {
                    if(!FieldManager.FieldExists(_productsProperty))
                    {
                        ...
                        if(PetShop.Tests.ObjF.ParameterizedSQL.Product.Exists(criteria))
                            LoadProperty(_productsProperty, PetShop.Tests.ObjF.ParameterizedSQL.Product.GetByProductId(ProductId));
                    }
                }
                ...
                if (!cancel)
                {
                    ...
                    if(!FieldManager.FieldExists(_suppliersProperty))
                    {
                        ...
                        if(PetShop.Tests.ObjF.ParameterizedSQL.Supplier.Exists(criteria))
                            LoadProperty(_suppliersProperty, PetShop.Tests.ObjF.ParameterizedSQL.Supplier.GetBySuppId(Supplier.Value));
                    }
                }
        ...
        public override bool IsDirty
        {
            get
            {
                ...
                if (FieldManager.FieldExists(_suppliersProperty) && Suppliers.IsDirty) return true;
