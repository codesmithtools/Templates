...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    {    
        ...
        {
            LineItem item = PetShop.Tests.ObjF.ParameterizedSQL.LineItem.NewLineItemChild();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Tests.ObjF.ParameterizedSQL.LineItem.NewLineItemChild();
        ...
        {
            PetShop.Tests.ObjF.ParameterizedSQL.LineItem.ExistsAsync(criteria,handler);
        }
