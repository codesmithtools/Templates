...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class ItemList : BusinessListBase<ItemList, Item>
    {
        ...
        {
            Item item = PetShop.Tests.ObjF.ParameterizedSQL.Item.NewItemChild();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Tests.ObjF.ParameterizedSQL.Item.NewItemChild();
        ...
        {
            PetShop.Tests.ObjF.ParameterizedSQL.Item.NewItemChildAsync((o, e) =>
            {
                if(e.Error == null)
                {
                    Add(e.Object);
        ...
        {
            PetShop.Tests.ObjF.ParameterizedSQL.Item.ExistsAsync(criteria,handler);
        }
