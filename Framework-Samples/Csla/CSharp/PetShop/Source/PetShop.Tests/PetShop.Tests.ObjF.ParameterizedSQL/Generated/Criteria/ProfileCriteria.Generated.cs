...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class ProfileCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public ProfileCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Profile)){}

        public ProfileCriteria(System.Int32 uniqueID) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Profile))
        {
            UniqueID = uniqueID;
        }
