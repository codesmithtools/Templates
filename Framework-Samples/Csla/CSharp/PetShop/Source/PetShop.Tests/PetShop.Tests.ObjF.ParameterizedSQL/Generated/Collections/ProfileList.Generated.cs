...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    {    
        ...
        {
            Profile item = PetShop.Tests.ObjF.ParameterizedSQL.Profile.NewProfileChild();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Tests.ObjF.ParameterizedSQL.Profile.NewProfileChild();
        ...
        {
            PetShop.Tests.ObjF.ParameterizedSQL.Profile.ExistsAsync(criteria,handler);
        }
