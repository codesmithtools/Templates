...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class OrderStatusCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public OrderStatusCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.OrderStatus)){}

        public OrderStatusCriteria(System.Int32 orderId, System.Int32 lineNum) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.OrderStatus))
        {
            OrderId = orderId;
            LineNum = lineNum;
        }
