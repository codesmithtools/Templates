...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class ProductList : DynamicBindingListBase<Product>
    {
        ...
        {
            Product item = PetShop.Tests.ObjF.ParameterizedSQL.Product.NewProductChild();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Tests.ObjF.ParameterizedSQL.Product.NewProductChild();
        ...
        {
            PetShop.Tests.ObjF.ParameterizedSQL.Product.ExistsAsync(criteria,handler);
        }
