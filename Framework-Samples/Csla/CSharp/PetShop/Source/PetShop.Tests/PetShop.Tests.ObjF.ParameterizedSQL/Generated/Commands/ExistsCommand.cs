...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public class ExistsCommand : CommandBase<ExistsCommand>
    {
        ...
        public static void ExecuteAsync<T>(T criteria, EventHandler<DataPortalResult<ExistsCommand>> handler) where T : PetShop.Tests.ObjF.ParameterizedSQL.IGeneratedCriteria
        {
            if (!CanExecuteCommand())
                throw new System.Security.SecurityException("Not authorized to execute command");
