    ...
    public partial class ProductFactory : ObjectFactory
    {
        ...
        private void DoInsert(ref Product item, bool stopProccessingChildren)
        {
            ...
            // Update Child Items.
                ...
                Update_Categories_Categories_FK__Product__Categor__0CBAE877(ref item);
        ...
        private static void Update_Categories_Categories_FK__Product__Categor__0CBAE877(ref Product item)
        {
                item.Categories.CategoryId = item.CategoryId;

            new CategoryFactory().Update(item.Categories, true);
        }
