    ...
    public partial class Account : BusinessBase<Account>
    {
                ...
                if (!cancel)
                {
                    if(!FieldManager.FieldExists(_profilesProperty))
                    {
                        ...
                        if(PetShop.Tests.ObjF.StoredProcedures.Profile.Exists(criteria))
                            LoadProperty(_profilesProperty, PetShop.Tests.ObjF.StoredProcedures.Profile.GetByUniqueID(UniqueID));
                    }
                }
        ...
        public override bool IsDirty
        {
            get
            {
                ...
                if (FieldManager.FieldExists(_profilesProperty) && Profiles.IsDirty) return true;
