...
{
    [Serializable]
    [Csla.Server.ObjectFactory(FactoryNames.SupplierListFactoryName)]
    public partial class SupplierList : BusinessListBase<SupplierList, Supplier>
    {
        ...
        {
            return DataPortal.Fetch<SupplierList>(new SupplierCriteria());
        }
        ...
        {
            Supplier item = PetShop.Tests.ObjF.StoredProcedures.Supplier.NewSupplier();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Tests.ObjF.StoredProcedures.Supplier.NewSupplier();
        ...
        {
            return await PetShop.Tests.ObjF.StoredProcedures.Supplier.NewSupplierAsync().ContinueWith(t => 
            {
        ...
        public new bool IsDirty
        {
            get
            {
                foreach(Supplier item in this.Items)
                {
        ...
        {
            return PetShop.Tests.ObjF.StoredProcedures.Supplier.Exists(criteria);
        }
        /// <summary>
        /// Determines if a record exists in the Supplier in the database for the specified criteria. 
        /// </summary>
