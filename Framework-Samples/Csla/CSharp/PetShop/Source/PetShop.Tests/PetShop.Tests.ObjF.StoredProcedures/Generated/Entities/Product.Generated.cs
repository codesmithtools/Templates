    ...
    public partial class Product : BusinessBase<Product>
    {
                ...
                if (!cancel)
                {
                    if(!FieldManager.FieldExists(_categoriesProperty))
                    {
                        ...
                        if(PetShop.Tests.ObjF.StoredProcedures.Category.Exists(criteria))
                            LoadProperty(_categoriesProperty, PetShop.Tests.ObjF.StoredProcedures.Category.GetByCategoryId(CategoryId));
                    }
                }
        ...
        public override bool IsDirty
        {
            get
            {
                ...
                if (FieldManager.FieldExists(_categoriesProperty) && Categories.IsDirty) return true;
