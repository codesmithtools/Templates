                ...
                if (!cancel)
                {
                    if(!FieldManager.FieldExists(_productsProperty))
                    {
                        ...
                        if(PetShop.Tests.ObjF.StoredProcedures.Product.Exists(criteria))
                            LoadProperty(_productsProperty, PetShop.Tests.ObjF.StoredProcedures.Product.GetByProductId(ProductId));
                    }
                }
                ...
                if (!cancel)
                {
                    ...
                    if(!FieldManager.FieldExists(_suppliersProperty))
                    {
                        ...
                        if(PetShop.Tests.ObjF.StoredProcedures.Supplier.Exists(criteria))
                            LoadProperty(_suppliersProperty, PetShop.Tests.ObjF.StoredProcedures.Supplier.GetBySuppId(Supplier.Value));
                    }
                }
