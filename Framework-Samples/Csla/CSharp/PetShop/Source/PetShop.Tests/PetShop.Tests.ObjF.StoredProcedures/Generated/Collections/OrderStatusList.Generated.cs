...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class OrderStatusList : BusinessListBase<OrderStatusList, OrderStatus>
    {
        ...
        internal static async Task<OrderStatusList> NewListAsync()
        {
            return await DataPortal.CreateAsync<OrderStatusList>();
        }

        internal static async Task<OrderStatusList> GetByOrderIdLineNumAsync(System.Int32 orderId, System.Int32 lineNum)
        {
            var criteria = new OrderStatusCriteria{OrderId = orderId, LineNum = lineNum};
            
            
            return await DataPortal.FetchAsync<AsyncChildLoader<OrderStatusList>>(criteria).ContinueWith(t => t.Result.Child);
        }

        internal static async Task<OrderStatusList> GetByOrderIdAsync(System.Int32 orderId)
        {
            var criteria = new OrderStatusCriteria{OrderId = orderId};
        ...
        internal static async Task<OrderStatusList> GetByCriteriaAsync(OrderStatusCriteria criteria)
        {  
            return await DataPortal.FetchAsync<AsyncChildLoader<OrderStatusList>>(criteria).ContinueWith(t => t.Result.Child);
        }

        internal static async Task<OrderStatusList> GetAllAsync()
        {
            return await DataPortal.FetchAsync<AsyncChildLoader<OrderStatusList>>(new OrderStatusCriteria()).ContinueWith(t => t.Result.Child);
        }
        ...
        protected async Task<OrderStatus> AddNewCoreAsync()
        {
            return await PetShop.Tests.ObjF.StoredProcedures.OrderStatus.NewOrderStatusAsync().ContinueWith(t => 
            {
                 OrderStatus item = t.Result;
