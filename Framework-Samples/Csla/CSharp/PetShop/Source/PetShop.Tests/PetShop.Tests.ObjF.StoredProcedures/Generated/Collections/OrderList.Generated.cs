...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class OrderList : BusinessListBase<OrderList, Order>
    {
        ...
        {
            Order item = PetShop.Tests.ObjF.StoredProcedures.Order.NewOrderChild();
            ...
            if (!cancel)
            {
                ...
                if(item == null)
                    item = PetShop.Tests.ObjF.StoredProcedures.Order.NewOrderChild();
        ...
        {
            PetShop.Tests.ObjF.StoredProcedures.Order.NewOrderChildAsync((o, e) =>
            {
                if(e.Error == null)
                {
                    Add(e.Object);
        ...
        {
            return PetShop.Tests.ObjF.StoredProcedures.Order.Exists(criteria);
        }
        ...
        {
            PetShop.Tests.ObjF.StoredProcedures.Order.ExistsAsync(criteria,handler);
        }
