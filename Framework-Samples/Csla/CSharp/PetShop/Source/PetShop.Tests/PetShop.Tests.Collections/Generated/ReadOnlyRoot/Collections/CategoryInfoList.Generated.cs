...
namespace PetShop.Tests.Collections.ReadOnlyRoot
{
    ...
    public partial class CategoryInfoList : ReadOnlyListBase<CategoryInfoList, CategoryInfo>
    {
        ...
        public static void GetByCategoryIdAsync(System.String categoryId, EventHandler<DataPortalResult<CategoryInfoList>> handler)
        {
            var criteria = new CategoryCriteria{CategoryId = categoryId};
        ...
        public static void GetByCriteriaAsync(CategoryCriteria criteria, EventHandler<DataPortalResult<CategoryInfoList>> handler)
        {  
            var dp = new DataPortal<CategoryInfoList>();
            dp.FetchCompleted += handler;
            dp.BeginFetch(criteria);
        ...
        public static void GetAllAsync(EventHandler<DataPortalResult<CategoryInfoList>> handler)
        {
            var dp = new DataPortal<CategoryInfoList>();
            dp.FetchCompleted += handler;
