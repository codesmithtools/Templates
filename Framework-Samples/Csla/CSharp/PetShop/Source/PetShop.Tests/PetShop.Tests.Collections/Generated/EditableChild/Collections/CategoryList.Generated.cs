...
namespace PetShop.Tests.Collections.EditableChild
{
    ...
    public partial class CategoryList : BusinessListBase<CategoryList, Category>
    {
        ...
        internal static async Task<CategoryList> GetByCategoryIdAsync(System.String categoryId)
        {
            var criteria = new CategoryCriteria{CategoryId = categoryId};
        ...
        {
            return await PetShop.Tests.Collections.EditableChild.Category.NewCategoryAsync().ContinueWith(t => 
            {
