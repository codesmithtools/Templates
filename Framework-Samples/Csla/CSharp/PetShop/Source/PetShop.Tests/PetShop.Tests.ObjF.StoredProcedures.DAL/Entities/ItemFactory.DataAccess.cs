    ...
    public partial class ItemFactory : ObjectFactory
    {
        ...
        private void DoInsert(ref Item item, bool stopProccessingChildren)
        {
            ...
            // Update Child Items.
                ...
                Update_Products_Products_FK__Item__ProductId__117F9D94(ref item);
                Update_Suppliers_Suppliers_FK__Item__Supplier__1273C1CD(ref item);
        ...
        private static void Update_Products_Products_FK__Item__ProductId__117F9D94(ref Item item)
        {
                item.Products.ProductId = item.ProductId;

            new ProductFactory().Update(item.Products, true);
        }
        //Associations.Where(a => a.AssociationType == AssociationType.ManyToOne || a.AssociationType == AssociationType.ManyToZeroOrOne)
        private static void Update_Suppliers_Suppliers_FK__Item__Supplier__1273C1CD(ref Item item)
        {
                item.Suppliers.SuppId = item.Supplier.Value;

            new SupplierFactory().Update(item.Suppliers, true);
        }
