...
namespace PetShop.Tests.ObjF.StoredProcedures.DAL
{
    public partial class LineItemFactory : ObjectFactory
    {
        ...
        private void DoInsert(ref LineItem item, bool stopProccessingChildren)
        {
            ...
            {
                connection.Open();
                using(var command = new SqlCommand("[dbo].[CSLA_LineItem_Insert]", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
            ...
            // Update Child Items.
                ...
                Update_Orders_Orders_FK__LineItem__OrderI__03317E3D(ref item);
        ...
        private void DoUpdate(ref LineItem item, bool stopProccessingChildren)
        {
            ...
            if (item.IsDirty)
            {
                ...
                {
                    connection.Open();
                    using(var command = new SqlCommand("[dbo].[CSLA_LineItem_Update]", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
        ...
        private static void Update_Orders_Orders_FK__LineItem__OrderI__03317E3D(ref LineItem item)
        {
