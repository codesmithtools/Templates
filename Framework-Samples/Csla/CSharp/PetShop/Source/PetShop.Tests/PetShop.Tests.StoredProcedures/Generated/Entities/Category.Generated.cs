...
namespace PetShop.Tests.StoredProcedures
{
    ...
    public partial class Category : BusinessBase<Category>
    {
        ...
        internal static void NewCategoryChildAsync(EventHandler<DataPortalResult<Category>> handler)
        {
            DataPortal<Category> dp = new DataPortal<Category>();
            dp.CreateCompleted += handler;
            dp.BeginCreate();
        }

        internal static void GetByCategoryIdChildAsync(System.String categoryId, EventHandler<DataPortalResult<Category>> handler)
        {
            var criteria = new CategoryCriteria{ CategoryId = categoryId};
