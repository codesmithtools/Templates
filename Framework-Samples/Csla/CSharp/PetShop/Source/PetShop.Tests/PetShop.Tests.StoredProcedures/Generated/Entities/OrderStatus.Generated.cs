...
namespace PetShop.Tests.StoredProcedures
{
    ...
    public partial class OrderStatus : BusinessBase<OrderStatus>
    {
        ...
        internal static async Task<OrderStatus> NewOrderStatusAsync()
        {
            return await DataPortal.CreateAsync<OrderStatus>();
        }

        internal static async Task<OrderStatus> GetByOrderIdLineNumAsync(System.Int32 orderId, System.Int32 lineNum)
        {
            var criteria = new OrderStatusCriteria{ OrderId = orderId, LineNum = lineNum};
            
            
            return await DataPortal.FetchAsync<AsyncChildLoader<OrderStatus>>(criteria).ContinueWith(t => t.Result.Child);
        }

        internal static async Task<OrderStatus> GetByOrderIdAsync(System.Int32 orderId)
        {
            var criteria = new OrderStatusCriteria{ OrderId = orderId};
