...
namespace PetShop.Tests.StoredProcedures
{
    ...
    public partial class Order : BusinessBase<Order>
    {
        ...
        public LineItemList LineItems
        {
            get
            {
                ...
                if (!cancel)
                {
                    ...
                    {
                        var criteria = new PetShop.Tests.StoredProcedures.LineItemCriteria {OrderId = OrderId};
                        
    
                        if(!PetShop.Tests.StoredProcedures.LineItemList.Exists(criteria))
        ...
        public OrderStatusList OrderStatuses
        {
            get
            {
                ...
                if (!cancel)
                {
                    ...
                    {
                        var criteria = new PetShop.Tests.StoredProcedures.OrderStatusCriteria {OrderId = OrderId};
                        
    
                        if(!PetShop.Tests.StoredProcedures.OrderStatusList.Exists(criteria))
        ...
        public static async Task<Order> GetByOrderIdAsync(System.Int32 orderId)
        {
            var criteria = new OrderCriteria{ OrderId = orderId};
            
            
            return await DataPortal.FetchAsync<Order>(criteria);
        }

        public static async Task DeleteOrderAsync(System.Int32 orderId)
        {
            var criteria = new OrderCriteria{OrderId = orderId};
            
            
            await DataPortal.DeleteAsync<Order>(criteria);
        }
        ...
        internal static async Task<Order> NewOrderChildAsync()
        {
            return await DataPortal.CreateAsync<Order>();
        }

        internal static async Task<Order> GetByOrderIdChildAsync(System.Int32 orderId)
        {
            var criteria = new OrderCriteria{ OrderId = orderId};
