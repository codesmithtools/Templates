...
BEGIN
    RAISERROR ('The procedure CSLA_Supplier_Insert has an Extended Property "CustomProcedure" which means is has been customised. Please review and remove the prop if you wish to drop the procedure.',16,1)
...
BEGIN
    RAISERROR ('The procedure CSLA_Supplier_Update has an Extended Property "CustomProcedure" which means is has been customised. Please review and remove the prop if you wish to drop the procedure.',16,1)
    INSERT INTO #tmpErrors (Error) SELECT 1
END
GO
...
BEGIN
    RAISERROR ('The procedure CSLA_Supplier_Delete has an Extended Property "CustomProcedure" which means is has been customised. Please review and remove the prop if you wish to drop the procedure.',16,1)
    INSERT INTO #tmpErrors (Error) SELECT 1
END
GO
...
BEGIN
    RAISERROR ('The procedure CSLA_Supplier_Select has an Extended Property "CustomProcedure" which means is has been customised. Please review and remove the prop if you wish to drop the procedure.',16,1)
    INSERT INTO #tmpErrors (Error) SELECT 1
END
GO
...
IF EXISTS(SELECT 1 FROM fn_listextendedproperty (NULL, 'SCHEMA', 'dbo', 'PROCEDURE', 'CSLA_Supplier_Insert', default, default) WHERE name = 'CustomProcedure' and value = '1')
    BEGIN
        RAISERROR ('The procedure [dbo].[CSLA_Supplier_Insert] has an Extended Property "CustomProcedure" which means is has been customized. Please review and remove the prop if you wish to create the stored procedure.',16,1)
        INSERT INTO #tmpErrors (Error) SELECT 1
    END
GO
...
IF EXISTS(SELECT 1 FROM fn_listextendedproperty (NULL, 'SCHEMA', 'dbo', 'PROCEDURE', 'CSLA_Supplier_Update', default, default) WHERE name = 'CustomProcedure' and value = '1')
    BEGIN
        RAISERROR ('The procedure [dbo].[CSLA_Supplier_Update] has an Extended Property "CustomProcedure" which means is has been customized. Please review and remove the prop if you wish to create the stored procedure.',16,1)
        INSERT INTO #tmpErrors (Error) SELECT 1
    END
GO
...
IF EXISTS(SELECT 1 FROM fn_listextendedproperty (NULL, 'SCHEMA', 'dbo', 'PROCEDURE', 'CSLA_Supplier_Delete', default, default) WHERE name = 'CustomProcedure' and value = '1')
    BEGIN
        RAISERROR ('The procedure [dbo].[CSLA_Supplier_Delete] has an Extended Property "CustomProcedure" which means is has been customized. Please review and remove the prop if you wish to create the stored procedure.',16,1)
        INSERT INTO #tmpErrors (Error) SELECT 1
    END
GO
...
IF EXISTS(SELECT 1 FROM fn_listextendedproperty (NULL, 'SCHEMA', 'dbo', 'PROCEDURE', 'CSLA_Supplier_Select', default, default) WHERE name = 'CustomProcedure' and value = '1')
    BEGIN
        RAISERROR ('The procedure [dbo].[CSLA_Supplier_Select] has an Extended Property "CustomProcedure" which means is has been customized. Please review and remove the prop if you wish to create the stored procedure.',16,1)
        INSERT INTO #tmpErrors (Error) SELECT 1
    END
GO
