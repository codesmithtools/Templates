            ...
            Get
                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_categoriesProperty))
                        ...
                        If (PetShop.Tests.OF.StoredProcedures.Category.Exists(criteria)) Then
                            LoadProperty(_categoriesProperty, PetShop.Tests.OF.StoredProcedures.Category.GetByCategoryId(CategoryId))
                        End If
                    End If
                End If
