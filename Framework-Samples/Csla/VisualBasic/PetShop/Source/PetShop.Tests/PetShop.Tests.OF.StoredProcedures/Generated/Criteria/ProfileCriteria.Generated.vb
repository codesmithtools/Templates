...
#Region "Read-Only"
        ...
        Public ReadOnly Property IsAnonymousHasValue As Boolean
            Get
                Return _bag.ContainsKey("IsAnonymous")
            End Get
        End Property
    
        Public ReadOnly Property LastActivityDateHasValue As Boolean
            Get
                Return _bag.ContainsKey("LastActivityDate")
            End Get
        End Property
    
        Public ReadOnly Property LastUpdatedDateHasValue As Boolean
            Get
                Return _bag.ContainsKey("LastUpdatedDate")
            End Get
        End Property
