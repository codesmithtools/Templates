...
#Region "Properties"
        ...
        Private Shared ReadOnly _productsProperty As PropertyInfo(Of Product) = RegisterProperty(Of Product)(Function(p As Item) p.Products, Csla.RelationshipTypes.Child)
        Public ReadOnly Property Products() As Product
            Get
                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_productsProperty))
                        Dim criteria As New PetShop.Tests.OF.StoredProcedures.ProductCriteria()
                        criteria.ProductId = ProductId

                        If (PetShop.Tests.OF.StoredProcedures.Product.Exists(criteria)) Then
                            LoadProperty(_productsProperty, PetShop.Tests.OF.StoredProcedures.Product.GetByProductId(ProductId))
                        End If
                    End If
                End If
        ...
        'Associations.Where(Function(a) a.AssociationType = AssociationType.ManyToOne OrElse a.AssociationType = AssociationType.ManyToZeroOrOne)
        Private Shared ReadOnly _suppliersProperty As PropertyInfo(Of Supplier) = RegisterProperty(Of Supplier)(Function(p As Item) p.Suppliers, Csla.RelationshipTypes.Child)
        Public ReadOnly Property Suppliers() As Supplier
            Get
                Dim cancel As Boolean = False
                OnChildLoading(_suppliersProperty, cancel)
                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_suppliersProperty))
                        ...
                        If (PetShop.Tests.OF.StoredProcedures.Supplier.Exists(criteria)) Then
                            LoadProperty(_suppliersProperty, PetShop.Tests.OF.StoredProcedures.Supplier.GetBySuppId(Supplier.Value))
                        End If
                    End If
                End If
            ...
            Public Overloads Overrides ReadOnly Property IsDirty() As Boolean
                Get
                    ...
                    If (FieldManager.FieldExists(_productsProperty) AndAlso Products.IsDirty) Then
                        Return True
                    End If
                    If (FieldManager.FieldExists(_suppliersProperty) AndAlso Suppliers.IsDirty) Then
                        Return True
                    End If
