...
Namespace PetShop.Tests.OF.StoredProcedures.DAL
    Public Partial Class AccountListFactory
...
#Region "Create"
        ...
        <RunLocal()> _
        Public Function Create() As AccountList
            Dim item As AccountList = CType(Activator.CreateInstance(GetType(AccountList), True), AccountList)
...
#Region "Fetch
        ...
        ''' <Returns></Returns>
        Public Function Fetch(ByVal criteria As AccountCriteria) As AccountList
            Dim item As AccountList = CType(Activator.CreateInstance(GetType(AccountList), True), AccountList)
