...
#Region "Method Overrides"
        ...
        Protected Overrides Function AddNewCore() As LineItem
            Dim item As LineItem = PetShop.Tests.OF.ParameterizedSQL.LineItem.NewLineItemChild()
            ...
            If Not (cancel) Then
                ...
                If(item Is Nothing) Then
                    item = PetShop.Tests.OF.ParameterizedSQL.LineItem.NewLineItemChild()
                End If
...
#Region "Exists Command"
        ...
        Public Shared Sub ExistsAsync(ByVal criteria As LineItemCriteria, ByVal handler As EventHandler(Of DataPortalResult(Of ExistsCommand)))
            PetShop.Tests.OF.ParameterizedSQL.LineItem.ExistsAsync(criteria, handler)
        End Sub
