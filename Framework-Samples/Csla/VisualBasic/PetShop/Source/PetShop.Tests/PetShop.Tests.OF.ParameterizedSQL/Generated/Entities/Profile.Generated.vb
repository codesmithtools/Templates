            ...
            Get
                ...
                If Not cancel Then
                    If Not (FieldManager.FieldExists(_accountsProperty)) Then
                        Dim criteria As New PetShop.Tests.OF.ParameterizedSQL.AccountCriteria()
                        criteria.UniqueID = UniqueID
    
                        If (Not PetShop.Tests.OF.ParameterizedSQL.AccountList.Exists(criteria)) Then
                            LoadProperty(_accountsProperty, PetShop.Tests.OF.ParameterizedSQL.AccountList.NewList())
                        Else
                            LoadProperty(_accountsProperty, PetShop.Tests.OF.ParameterizedSQL.AccountList.GetByUniqueID(UniqueID))
                        End If
                    End If
                End If
            ...
            Get
                ...
                If Not cancel Then
                    If Not (FieldManager.FieldExists(_cartsProperty)) Then
                        Dim criteria As New PetShop.Tests.OF.ParameterizedSQL.CartCriteria()
                        criteria.UniqueID = UniqueID
    
                        If (Not PetShop.Tests.OF.ParameterizedSQL.CartList.Exists(criteria)) Then
                            LoadProperty(_cartsProperty, PetShop.Tests.OF.ParameterizedSQL.CartList.NewList())
                        Else
                            LoadProperty(_cartsProperty, PetShop.Tests.OF.ParameterizedSQL.CartList.GetByUniqueID(UniqueID))
                        End If
                    End If
                End If
...
#Region "DataPortal partial methods"
        ...
        ''' </summary>
        ''' <param name="criteria"><see cref="ProfileCriteria"/> object containg the criteria of the object to delete.</param>
