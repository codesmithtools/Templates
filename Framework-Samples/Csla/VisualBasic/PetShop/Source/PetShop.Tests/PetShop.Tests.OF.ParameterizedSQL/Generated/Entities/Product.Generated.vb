...
#Region "Properties"
        ...
        Private Shared ReadOnly _categoriesProperty As PropertyInfo(Of Category) = RegisterProperty(Of Category)(Function(p As Product) p.Categories, Csla.RelationshipTypes.Child)
        Public ReadOnly Property Categories() As Category
            Get
                Dim cancel As Boolean = False
                OnChildLoading(_categoriesProperty, cancel)
                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_categoriesProperty))
                        Dim criteria As New PetShop.Tests.OF.ParameterizedSQL.CategoryCriteria()
                        criteria.CategoryId = CategoryId

                        If (PetShop.Tests.OF.ParameterizedSQL.Category.Exists(criteria)) Then
                            LoadProperty(_categoriesProperty, PetShop.Tests.OF.ParameterizedSQL.Category.GetByCategoryId(CategoryId))
                        End If
                    End If
                End If
            ...
            Get
                ...
                If Not cancel Then
                    If Not (FieldManager.FieldExists(_itemsProperty)) Then
                        ...
                        Else
                            LoadProperty(_itemsProperty, PetShop.Tests.OF.ParameterizedSQL.ItemList.GetByProductId(ProductId))
                        End If
                    End If
                End If
...
#Region "Overridden properties"
            ...
            Public Overloads Overrides ReadOnly Property IsDirty() As Boolean
                Get
                    ...
                    If (FieldManager.FieldExists(_categoriesProperty) AndAlso Categories.IsDirty) Then
                        Return True
                    End If
