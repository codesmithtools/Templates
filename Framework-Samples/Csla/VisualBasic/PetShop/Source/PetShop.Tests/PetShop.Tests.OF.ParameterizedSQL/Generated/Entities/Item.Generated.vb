                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_productsProperty))
                        ...
                        If (PetShop.Tests.OF.ParameterizedSQL.Product.Exists(criteria)) Then
                            LoadProperty(_productsProperty, PetShop.Tests.OF.ParameterizedSQL.Product.GetByProductId(ProductId))
                        End If
                    End If
                End If
                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_suppliersProperty))
                        ...
                        If (PetShop.Tests.OF.ParameterizedSQL.Supplier.Exists(criteria)) Then
                            LoadProperty(_suppliersProperty, PetShop.Tests.OF.ParameterizedSQL.Supplier.GetBySuppId(Supplier.Value))
                        End If
                    End If
                End If
