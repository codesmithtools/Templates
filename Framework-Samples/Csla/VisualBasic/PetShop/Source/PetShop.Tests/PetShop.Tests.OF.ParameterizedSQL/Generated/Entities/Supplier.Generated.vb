...
#Region "Business Rules"
        ...
        Protected Overrides Sub AddBusinessRules()
            ...
            BusinessRules.AddRule(New Global.Csla.Rules.CommonRules.MaxLength(_addr1Property, 80))
            BusinessRules.AddRule(New Global.Csla.Rules.CommonRules.MaxLength(_addr2Property, 80))
            ...
            BusinessRules.AddRule(New Global.Csla.Rules.CommonRules.MaxLength(_zipProperty, 5))
            BusinessRules.AddRule(New Global.Csla.Rules.CommonRules.MaxLength(_phoneProperty, 40))
        End Sub
...
#Region "Properties"
        ...
        Private Shared ReadOnly _suppIdProperty As PropertyInfo(Of System.Int32) = RegisterProperty(Of System.Int32)(Function(p As Supplier) p.SuppId, "Supp Id")
        ...
        Private Shared ReadOnly _originalSuppIdProperty As PropertyInfo(Of System.Int32) = RegisterProperty(Of System.Int32)(Function(p As Supplier) p.OriginalSuppId, "Original Supp Id")
        ''' <summary>
        ...
        Private Shared ReadOnly _nameProperty As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.Name, "Name", vbNullString)
        ...
        Private Shared ReadOnly _statusProperty As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.Status, "Status")
        ...
        Private Shared ReadOnly _addr1Property As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.Addr1, "Addr 1", vbNullString)
        ...
        Private Shared ReadOnly _addr2Property As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.Addr2, "Addr 2", vbNullString)
        ...
        Private Shared ReadOnly _cityProperty As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.City, "City", vbNullString)
        ...
        Private Shared ReadOnly _stateProperty As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.State, "State", vbNullString)
        ...
        Private Shared ReadOnly _zipProperty As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.Zip, "Zip", vbNullString)
        ...
        Private Shared ReadOnly _phoneProperty As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Supplier) p.Phone, "Phone", vbNullString)
            ...
            Get
                ...
                If Not cancel Then
                    If Not (FieldManager.FieldExists(_itemsProperty)) Then
                        Dim criteria As New PetShop.Tests.OF.ParameterizedSQL.ItemCriteria()
                        criteria.Supplier = SuppId
    
                        If (Not PetShop.Tests.OF.ParameterizedSQL.ItemList.Exists(criteria)) Then
                            LoadProperty(_itemsProperty, PetShop.Tests.OF.ParameterizedSQL.ItemList.NewList())
                        Else
                            LoadProperty(_itemsProperty, PetShop.Tests.OF.ParameterizedSQL.ItemList.GetBySupplier(SuppId))
                        End If
                    End If
                End If
...
#Region "Exists Command"
        ...
        ''' <summary>
        ''' Determines if a record exists in the [dbo].[Supplier] table in the database for the specified criteria. 
        ''' </summary>
