...
#Region "Method Overrides"
        ...
        Protected Overrides Function AddNewCore() As Profile
            Dim item As Profile = PetShop.Tests.OF.ParameterizedSQL.Profile.NewProfileChild()
            ...
            If Not (cancel) Then
                ...
                If(item Is Nothing) Then
                    item = PetShop.Tests.OF.ParameterizedSQL.Profile.NewProfileChild()
                End If
                Add(item)
            End If
...
#Region "Exists Command"
        ...
        Public Shared Function Exists(ByVal criteria As ProfileCriteria) As Boolean
            Return PetShop.Tests.OF.ParameterizedSQL.Profile.Exists(criteria)
        End Function
        ...
        Public Shared Sub ExistsAsync(ByVal criteria As ProfileCriteria, ByVal handler As EventHandler(Of DataPortalResult(Of ExistsCommand)))
            PetShop.Tests.OF.ParameterizedSQL.Profile.ExistsAsync(criteria, handler)
        End Sub
