...
Namespace PetShop.Tests.Collections.EditableChild
    Public Partial Class CategoryList
        ...
        Private Shadows Sub Child_Fetch(ByVal criteria As CategoryCriteria)
            Dim cancel As Boolean = False
            ...
            Using connection As New SqlConnection(ADOHelper.ConnectionString)
                ...
                command.Parameters.AddWithValue("@p_DescnHasValue", criteria.DescriptionHasValue)
                    Using reader As SafeDataReader = New SafeDataReader(command.ExecuteReader())
                        If reader.Read() Then
                            Do
                                Me.Add(PetShop.Tests.Collections.EditableChild.Category.GetCategory(reader))
        ...
        For Each item As Category In DeletedList
        ...
        For Each item As Category In Items
