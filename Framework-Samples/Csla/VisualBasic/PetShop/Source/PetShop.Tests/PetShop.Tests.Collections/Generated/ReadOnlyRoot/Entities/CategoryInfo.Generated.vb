...
#Region "Asynchronous Factory Methods"
        ...
        Public Shared Function GetByCategoryIdAsync(ByVal categoryId As System.String, ByVal handler As EventHandler(Of DataPortalResult(Of CategoryInfo))) As CategoryInfo
