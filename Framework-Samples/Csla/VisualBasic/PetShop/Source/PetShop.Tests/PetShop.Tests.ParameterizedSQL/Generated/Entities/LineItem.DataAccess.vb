...
#Region "Child_Insert"
        ...
        Private Sub Child_Insert(ByVal order As Order, ByVal connection As SqlConnection)
            Dim cancel As Boolean = False
            OnChildInserting(order, connection, cancel)
            If (cancel) Then
                Return
            End If
...
#Region "Child_Update"
        ...
        Private Sub Child_Update(ByVal order As Order, ByVal connection As SqlConnection)
            Dim cancel As Boolean = False
            OnChildUpdating(order, connection, cancel)
            If (cancel) Then
                Return
            End If
