...
#Region "Method Overrides"
        ...
        Protected Overrides Function AddNewCore() As Order
            Dim item As Order = PetShop.Tests.ParameterizedSQL.Order.NewOrderChild()
...
#Region "Synchronous Factory Methods"
        ...
        Public Shared Function GetByCriteria(ByVal criteria As OrderCriteria) As OrderList
            Return DataPortal.Fetch(Of OrderList)(criteria)
        End Function
...
#Region "Asynchronous Factory Methods"
        ...
        Public Shared Sub NewListAsync(ByVal handler As EventHandler(Of DataPortalResult(Of OrderList)))
            Dim dp As New DataPortal(Of OrderList)()
            AddHandler dp.CreateCompleted, handler
            dp.BeginCreate()
        End Sub
    
        Public Shared Sub GetByOrderIdAsync(ByVal orderId As System.Int32, ByVal handler As EventHandler(Of DataPortalResult(Of OrderList)))
            Dim dp As New DataPortal(Of OrderList)()
        ...
        Public Shared Sub GetByCriteriaAsync(ByVal criteria As OrderCriteria, ByVal handler As EventHandler(Of DataPortalResult(Of OrderList)))
            Dim dp As New DataPortal(Of OrderList)()
            AddHandler dp.FetchCompleted, handler
        ...
        Public Shared Sub GetAllAsync(ByVal handler As EventHandler(Of DataPortalResult(Of OrderList)))
            Dim dp As New DataPortal(Of OrderList)()
            AddHandler dp.FetchCompleted, handler
