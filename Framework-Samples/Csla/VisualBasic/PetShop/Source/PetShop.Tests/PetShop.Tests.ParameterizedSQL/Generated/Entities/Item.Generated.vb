                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_productsProperty))
                        ...
                        If (PetShop.Tests.ParameterizedSQL.Product.Exists(criteria)) Then
                            LoadProperty(_productsProperty, PetShop.Tests.ParameterizedSQL.Product.GetByProductId(ProductId))
                        End If
                    End If
                End If
                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_suppliersProperty))
                        ...
                        If (PetShop.Tests.ParameterizedSQL.Supplier.Exists(criteria)) Then
                            LoadProperty(_suppliersProperty, PetShop.Tests.ParameterizedSQL.Supplier.GetBySuppId(Supplier.Value))
                        End If
                    End If
                End If
