...
#Region "Insert"
        ...
        Private Sub DoInsert(ByRef item As Product, ByVal stopProccessingChildren As Boolean)
            ...
            If Not (stopProccessingChildren) Then
                ...
                Update_Categories_Categories_FK__Product__Categor__0CBAE877(item)
...
#Region "Helper Methods"
        ...
        Private Shared Sub  Update_Categories_Categories_FK__Product__Categor__0CBAE877(ByRef item As Product)
            item.Categories.CategoryId = item.CategoryId
    
            Dim factory As New CategoryFactory
            factory.Update(item.Categories, True)
        End Sub
