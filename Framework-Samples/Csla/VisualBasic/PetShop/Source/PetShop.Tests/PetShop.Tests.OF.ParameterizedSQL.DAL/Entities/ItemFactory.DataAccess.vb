...
#Region "Insert"
        ...
        Private Sub DoInsert(ByRef item As Item, ByVal stopProccessingChildren As Boolean)
            ...
            If Not (stopProccessingChildren) Then
                ...
                Update_Products_Products_FK__Item__ProductId__117F9D94(item)
                Update_Suppliers_Suppliers_FK__Item__Supplier__1273C1CD(item)
...
#Region "Helper Methods"
        ...
        Private Shared Sub  Update_Products_Products_FK__Item__ProductId__117F9D94(ByRef item As Item)
            item.Products.ProductId = item.ProductId
    
            Dim factory As New ProductFactory
            factory.Update(item.Products, True)
        End Sub
        'Associations.Where(Function(a) a.AssociationType = AssociationType.ManyToOne OrElse a.AssociationType = AssociationType.ManyToZeroOrOne)
        Private Shared Sub  Update_Suppliers_Suppliers_FK__Item__Supplier__1273C1CD(ByRef item As Item)
            item.Suppliers.SuppId = item.Supplier.Value
    
            Dim factory As New SupplierFactory
            factory.Update(item.Suppliers, True)
        End Sub
