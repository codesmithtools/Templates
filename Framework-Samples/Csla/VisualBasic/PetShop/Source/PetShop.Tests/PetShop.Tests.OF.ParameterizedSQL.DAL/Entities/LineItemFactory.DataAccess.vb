...
#Region "Insert"
        ...
        Private Sub DoInsert(ByRef item As LineItem, ByVal stopProccessingChildren As Boolean)
            ...
            If Not (stopProccessingChildren) Then
                ' Update Child Items.
                Update_Order_Order_FK__LineItem__OrderI__03317E3D(item)
            End If
...
#Region "Helper Methods"
        ...
        Private Shared Sub  Update_Order_Order_FK__LineItem__OrderI__03317E3D(ByRef item As LineItem)
            item.Order.OrderId = item.OrderId
    
            Dim factory As New OrderFactory
            factory.Update(item.Order, True)
        End Sub
