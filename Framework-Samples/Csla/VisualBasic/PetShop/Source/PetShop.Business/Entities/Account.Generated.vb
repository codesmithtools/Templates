...
#End If
        ...
        Private Shared ReadOnly _profilesProperty As PropertyInfo(Of Profile) = RegisterProperty(Of Profile)(Function(p As Account) p.Profiles, Csla.RelationshipTypes.Child)
        Public ReadOnly Property Profiles() As Profile
            Get
                Dim cancel As Boolean = False
                OnChildLoading(_profilesProperty, cancel)
                ...
                If Not cancel Then
                    ...
                    If Not(FieldManager.FieldExists(_profilesProperty))
                        Dim criteria As New PetShop.Business.ProfileCriteria()
                        criteria.UniqueID = UniqueID

#If SILVERLIGHT Then
                        'Markbusy()
                        PetShop.Business.Profile.ExistsAsync(criteria, Sub(o, e)
                            ...
                            If (e.Object.Result) Then
                                PetShop.Business.Profile.GetByUniqueIDAsync(UniqueID, Sub(o1, e1)
                                    ...
                                    Me.LoadProperty(_profilesProperty, e1.Object)

                                    'MarkIdle()
                                    OnPropertyChanged(_profilesProperty)
                                End Sub)
                            End If
                        End Sub)
#Else
                        If (PetShop.Business.Profile.Exists(criteria)) Then
                            LoadProperty(_profilesProperty, PetShop.Business.Profile.GetByUniqueID(UniqueID))
                        End If
#End If
                    End If
                End If

                Return GetProperty(_profilesProperty) 
            End Get
        End Property
...
#If Not SILVERLIGHT Then
        ...
        Friend Shared Function GetAccount(ByVal reader As SafeDataReader) As Account
            Return DataPortal.FetchChild(Of Account)(reader)
        End Function
