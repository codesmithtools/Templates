...
#If SILVERLIGHT Then
                        'Markbusy()
                        PetShop.Business.Product.ExistsAsync(criteria, Sub(o, e)
...
#If SILVERLIGHT Then
                        'Markbusy()
                        PetShop.Business.Supplier.ExistsAsync(criteria, Sub(o, e)
                            If Not (e.Error Is Nothing) Then
                                Throw e.Error
                            End If
                            ...
                            If (e.Object.Result) Then
                                PetShop.Business.Supplier.GetBySuppIdAsync(Supplier.Value, Sub(o1, e1)
                                    ...
                                    Me.LoadProperty(_suppliersProperty, e1.Object)
