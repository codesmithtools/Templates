...
#End If
        ...
        Private Shared ReadOnly _profilesProperty As PropertyInfo(Of Profile) = RegisterProperty(Of Profile)(Function(p As Cart) p.Profiles, Csla.RelationshipTypes.Child)
...
#If Not SILVERLIGHT Then
        ...
        Friend Shared Function GetCart(ByVal reader As SafeDataReader) As Cart
            Return DataPortal.FetchChild(Of Cart)(reader)
        End Function
