...
#If SILVERLIGHT Then
                        ...
                        If ((True)) Then
                            PetShop.Business.ItemList.ExistsAsync(criteria, Sub(o, e)
...
#If Not SILVERLIGHT Then
        ...
        Friend Shared Function GetSupplier(ByVal reader As SafeDataReader) As Supplier
            Return DataPortal.FetchChild(Of Supplier)(reader)
        End Function
