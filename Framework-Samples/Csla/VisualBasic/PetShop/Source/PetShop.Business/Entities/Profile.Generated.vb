...
#If SILVERLIGHT Then
                        ...
                        If ((True)) Then
                            PetShop.Business.AccountList.ExistsAsync(criteria, Sub(o, e)
...
#If SILVERLIGHT Then
                        ...
                        If ((True)) Then
                            PetShop.Business.CartList.ExistsAsync(criteria, Sub(o, e)
                                If Not (e.Error Is Nothing) Then
                                    Throw e.Error
                                End If
...
#If Not SILVERLIGHT Then
        ...
        Friend Shared Function GetProfile(ByVal reader As SafeDataReader) As Profile
            Return DataPortal.FetchChild(Of Profile)(reader)
        End Function
#End If
#End Region
