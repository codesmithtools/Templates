...
#If SILVERLIGHT Then
                        'Markbusy()
                        PetShop.Business.Category.ExistsAsync(criteria, Sub(o, e)
                            ...
                            If (e.Object.Result) Then
                                PetShop.Business.Category.GetByCategoryIdAsync(CategoryId, Sub(o1, e1)
                                    ...
                                    Me.LoadProperty(_categoriesProperty, e1.Object)

                                    'MarkIdle()
                                    OnPropertyChanged(_categoriesProperty)
                                End Sub)
                            End If
                        End Sub)
#Else
                        If (PetShop.Business.Category.Exists(criteria)) Then
                            LoadProperty(_categoriesProperty, PetShop.Business.Category.GetByCategoryId(CategoryId))
                        End If
#End If
                    End If
                End If
