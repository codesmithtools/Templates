...
#End If
        ...
        Private Shared ReadOnly _ordersProperty As PropertyInfo(Of Order) = RegisterProperty(Of Order)(Function(p As LineItem) p.Orders, Csla.RelationshipTypes.Child)
                        ...
                        PetShop.Business.Order.ExistsAsync(criteria, Sub(o, e)
                            ...
                            If (e.Object.Result) Then
                                PetShop.Business.Order.GetByOrderIdAsync(OrderId, Sub(o1, e1)
                                    ...
                                    Me.LoadProperty(_ordersProperty, e1.Object)

                                    'MarkIdle()
                                    OnPropertyChanged(_ordersProperty)
                                End Sub)
                            End If
                        End Sub)
#Else
                        If (PetShop.Business.Order.Exists(criteria)) Then
                            LoadProperty(_ordersProperty, PetShop.Business.Order.GetByOrderId(OrderId))
                        End If
#End If
                    End If
                End If
