...
#Region "Serialization"
        ...
        Protected Overrides Sub OnGetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            If _bag.ContainsKey("IsAnonymous") Then
                info.AddValue("IsAnonymous", GetValue(Of System.Boolean?)("IsAnonymous"))
            End If
            If _bag.ContainsKey("LastActivityDate") Then
                info.AddValue("LastActivityDate", GetValue(Of System.DateTime?)("LastActivityDate"))
            End If
            If _bag.ContainsKey("LastUpdatedDate") Then
                info.AddValue("LastUpdatedDate", GetValue(Of System.DateTime?)("LastUpdatedDate"))
            End If
        End Sub
        ...
        Protected Overrides Sub OnSetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            If info.Values.ContainsKey("IsAnonymous") Then
                _bag("IsAnonymous") = info.GetValue(Of System.Boolean?)("IsAnonymous")
            End If
            If info.Values.ContainsKey("LastActivityDate") Then
                _bag("LastActivityDate") = info.GetValue(Of System.DateTime?)("LastActivityDate")
            End If
            If info.Values.ContainsKey("LastUpdatedDate") Then
                _bag("LastUpdatedDate") = info.GetValue(Of System.DateTime?)("LastUpdatedDate")
            End If
        End Sub
