...
Namespace PetShop.Business
    ...
    Public Partial Class InventoryCriteria
        Inherits CriteriaBase(Of InventoryCriteria)
...
#Region "Serialization"
        ...
        Protected Overrides Sub OnGetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            End If
            If _bag.ContainsKey("Qty") Then
                info.AddValue("Qty", GetValue(Of System.Int32)("Qty"))
            End If
        End Sub
        ...
        Protected Overrides Sub OnSetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            End If
            If info.Values.ContainsKey("Qty") Then
                _bag("Qty") = info.GetValue(Of System.Int32)("Qty")
            End If
        End Sub
