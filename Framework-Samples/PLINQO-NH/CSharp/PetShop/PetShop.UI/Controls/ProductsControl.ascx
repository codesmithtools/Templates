        ...
        <ItemTemplate>
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="26">&nbsp;</td>
                    <td valign="top" width="120"><a href='Items.aspx?productId=<%# Eval("ProductId") %>&categoryId=<%# Eval("Category.CategoryId") %>'><div class="productName"><%# Eval("Name") %></div></a><div class="productDescription"><%# Eval("Descn") %></div></td>                    
                </tr>               
            </table>            
        </ItemTemplate>
