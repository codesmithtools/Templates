...
namespace PetShop.UI.Controls
{
    public partial class AddressForm : System.Web.UI.UserControl
    {
        ...
        /// </summary>
        public PetShop.Core.Model.Address Address
        {
            get
            {
                if(IsValid == false)
                ...
                return new PetShop.Core.Model.Address(firstName, lastName, address1, address2, city, state, zip, country, phone, email);
            }
            set
            {
                if (value != null)
