...
Namespace Tracker.Core.Data
    ...
    Partial Public Class TaskExtendedManager 
        Inherits CodeSmith.Data.EntityManagerBase(Of TrackerDataManager, Tracker.Core.Data.TaskExtended)
        ...
        ''' </summary>
        Protected ReadOnly Property Entity() As System.Data.Linq.Table(Of Tracker.Core.Data.TaskExtended)
            Get 
                return Manager.Context.TaskExtended
            End Get
        End Property
        ...
        ''' </summary>
        Public Shared Function CreateKey(ByVal taskId As Integer) As CodeSmith.Data.IEntityKey(Of Integer)
            Return New CodeSmith.Data.EntityKey(Of Integer)(taskId)
        End Function
        ...
        Public Overrides Function GetByKey(ByVal key As CodeSmith.Data.IEntityKey) As Tracker.Core.Data.TaskExtended
        ...
        Public Overloads Function GetByKey(ByVal taskId As Integer) As Tracker.Core.Data.TaskExtended
            If (Context.LoadOptions Is Nothing) Then 
                return Query.GetByKey.Invoke(Context, taskId)
            Else
                return Entity.FirstOrDefault(Function(t)t.TaskId = taskId)
            End If
        End Function
        ...
        Public Function Delete(ByVal taskId As Integer) As Integer
            return Entity.Delete(Function(t)t.TaskId = taskId)
        End Function
        ...
        Private Partial Class Query
            ...
            Friend Shared Readonly GetByKey As Func(Of Tracker.Core.Data.TrackerDataContext, Integer, Tracker.Core.Data.TaskExtended) = _
