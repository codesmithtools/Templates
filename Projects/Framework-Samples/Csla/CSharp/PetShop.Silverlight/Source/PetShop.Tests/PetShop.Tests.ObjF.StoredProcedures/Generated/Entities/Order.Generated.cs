    ...
    public partial class Order : BusinessBase< Order >
    {
        ...
        public LineItemList LineItems
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.StoredProcedures.LineItemList.Exists(new PetShop.Tests.ObjF.StoredProcedures.LineItemCriteria {OrderId = OrderId}))
        ...
        public OrderStatusList OrderStatuses
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.StoredProcedures.OrderStatusList.Exists(new PetShop.Tests.ObjF.StoredProcedures.OrderStatusCriteria {OrderId = OrderId}))
