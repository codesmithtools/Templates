...
namespace PetShop.Tests.StoredProcedures
{
    public partial class SupplierList
    {
        ...
        protected void AddAuthorizationRules()
        {
            ...
            // AuthorizationRules.AllowCreate(typeof(SupplierList), admin);
            // AuthorizationRules.AllowDelete(typeof(SupplierList), admin);
            // AuthorizationRules.AllowEdit(typeof(SupplierList), canWrite);
            // AuthorizationRules.AllowGet(typeof(SupplierList), canRead);
