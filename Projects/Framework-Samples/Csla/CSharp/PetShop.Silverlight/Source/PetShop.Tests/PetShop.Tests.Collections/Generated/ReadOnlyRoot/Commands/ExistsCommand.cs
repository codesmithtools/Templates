...
namespace PetShop.Tests.Collections.ReadOnlyRoot
{
    ...
    public class ExistsCommand : CommandBase<ExistsCommand>
    {
        ...
        private PetShop.Tests.Collections.ReadOnlyRoot.IGeneratedCriteria Criteria { get; set; }
        private bool Result { get; set; }

        private void BeforeServer(PetShop.Tests.Collections.ReadOnlyRoot.IGeneratedCriteria criteria)
        {
            Criteria = criteria;
            Result = false;
        }
