...
namespace PetShop.Tests.Collections.ReadOnlyChild
{
    public partial class CategoryInfoList
    {
        ...
        protected void AddAuthorizationRules()
        {
            ...
            // AuthorizationRules.AllowCreate(typeof(CategoryInfoList), admin);
            // AuthorizationRules.AllowDelete(typeof(CategoryInfoList), admin);
            // AuthorizationRules.AllowEdit(typeof(CategoryInfoList), canWrite);
            // AuthorizationRules.AllowGet(typeof(CategoryInfoList), canRead);
