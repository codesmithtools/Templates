            ...
            get
            {
                if(!FieldManager.FieldExists(_productMemberProperty))
                {
                    ...
                    if(PetShop.Business.Product.Exists(criteria))
                        PetShop.Business.Product.GetByProductIdAsync(ProductId, (o, e) =>
                            {
                                if (e.Error != null)
                                    throw e.Error; 

                                this.LoadProperty(_productMemberProperty, e.Object);
            ...
            get
            {
                ...
                if(!FieldManager.FieldExists(_supplierMemberProperty))
                {
                    ...
                    if(PetShop.Business.Supplier.Exists(criteria))
                        PetShop.Business.Supplier.GetBySuppIdAsync(Supplier.Value, (o, e) =>
                            {
                                if (e.Error != null)
                                    throw e.Error; 

                                this.LoadProperty(_supplierMemberProperty, e.Object);
