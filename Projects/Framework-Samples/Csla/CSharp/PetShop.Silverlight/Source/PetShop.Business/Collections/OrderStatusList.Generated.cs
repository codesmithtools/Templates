...
namespace PetShop.Business
{
    ...
    public partial class OrderStatusList : BusinessListBase< OrderStatusList, OrderStatus >
    {
        ...
        internal static void NewListAsync(EventHandler<DataPortalResult<OrderStatus>> handler)
		{
        ...
        internal static void GetByOrderIdLineNumAsync(System.Int32 orderId, System.Int32 lineNum, EventHandler<DataPortalResult<OrderStatus>> handler)
        {
			var criteria = new OrderStatusCriteria{OrderId = orderId, LineNum = lineNum};
        ...
        internal static void GetByOrderIdAsync(System.Int32 orderId, EventHandler<DataPortalResult<OrderStatus>> handler)
        {
			var criteria = new OrderStatusCriteria{OrderId = orderId};
        ...
        internal static void GetAllAsync(EventHandler<DataPortalResult<OrderStatus>> handler)
        {
            // How should this be called? In the sync method we call FetchChild.
            var dp = new DataPortal<OrderStatus>();
			dp.FetchCompleted += handler;
