    ...
    public partial class Item : BusinessBase< Item >
    {
        ...
        public Product ProductMember
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Business.Product.Exists(new PetShop.Business.ProductCriteria {ProductId = ProductId}))
        ...
        public Supplier SupplierMember
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Business.Supplier.Exists(new PetShop.Business.SupplierCriteria {SuppId = Supplier.Value}))
        ...
        public override bool IsDirty
        {
            get
            {
                ...
                if (ProductMember.IsDirty) return true;
                if (SupplierMember.IsDirty) return true;
