    ...
    public partial class Profile : BusinessBase< Profile >
    {
        ...
        public AccountList Accounts
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Business.AccountList.Exists(new PetShop.Business.AccountCriteria {UniqueID = UniqueID}))
        ...
        public CartList Carts
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Business.CartList.Exists(new PetShop.Business.CartCriteria {UniqueID = UniqueID}))
