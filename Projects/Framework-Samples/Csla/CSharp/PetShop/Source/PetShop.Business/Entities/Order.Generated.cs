    ...
    public partial class Order : BusinessBase< Order >
    {
        ...
        public LineItemList LineItems
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Business.LineItemList.Exists(new PetShop.Business.LineItemCriteria {OrderId = OrderId}))
        ...
        public OrderStatusList OrderStatuses
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Business.OrderStatusList.Exists(new PetShop.Business.OrderStatusCriteria {OrderId = OrderId}))
