...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class CategoryCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public CategoryCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Category)){}

        public CategoryCriteria(System.String categoryId) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Category))
        {
