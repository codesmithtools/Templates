    ...
    public partial class Product : BusinessBase< Product >
    {
        ...
        public Category CategoryMember
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.ParameterizedSQL.Category.Exists(new PetShop.Tests.ObjF.ParameterizedSQL.CategoryCriteria {CategoryId = CategoryId}))
                        LoadProperty(_categoryMemberProperty, PetShop.Tests.ObjF.ParameterizedSQL.Category.NewCategory());
                    else
                        LoadProperty(_categoryMemberProperty, PetShop.Tests.ObjF.ParameterizedSQL.Category.GetByCategoryId(CategoryId));
                }
        ...
        public ItemList Items
        {
            get
            {
                ...
                {
                    if(IsNew || !PetShop.Tests.ObjF.ParameterizedSQL.ItemList.Exists(new PetShop.Tests.ObjF.ParameterizedSQL.ItemCriteria {ProductId = ProductId}))
        ...
        public override bool IsDirty
        {
            get
            {
                ...
                if (CategoryMember.IsDirty) return true;
