...
namespace PetShop.Tests.ObjF.StoredProcedures.DAL
{
    public partial class AccountFactory : ObjectFactory
    {
        ...
        private void DoInsert(Account item, bool stopProccessingChildren)
        {
        ...
        private void DoUpdate(Account item, bool stopProccessingChildren)
        {
            bool cancel = false;
        ...
        protected void DoDelete(Account item)
        {
