...
namespace PetShop.Tests.ObjF.StoredProcedures.DAL
{
    public partial class ProfileFactory : ObjectFactory
    {
        ...
        private void DoInsert(Profile item, bool stopProccessingChildren)
        {
            ...
            using (SqlConnection connection = new SqlConnection(ADOHelper.ConnectionString))
            {
                ...
                using(SqlCommand command = new SqlCommand("[dbo].[CSLA_Profile_Insert]", connection))
                {
					...
					command.Parameters.AddWithValue("@p_IsAnonymous", item.IsAnonymous);
					command.Parameters.AddWithValue("@p_LastActivityDate", item.LastActivityDate);
					command.Parameters.AddWithValue("@p_LastUpdatedDate", item.LastUpdatedDate);
        ...
        private void DoUpdate(Profile item, bool stopProccessingChildren)
        {
            bool cancel = false;
        ...
        protected void DoDelete(Profile item)
        {
            ...
            DoDelete(new ProfileCriteria{UniqueID = item.UniqueID});
        ...
        public Profile Map(SafeDataReader reader)
        {
            ...
            using (BypassPropertyChecks(item))
            {
                ...
                item.IsAnonymous = reader.GetBoolean("IsAnonymous");
                item.LastActivityDate = reader.GetDateTime("LastActivityDate");
                item.LastUpdatedDate = reader.GetDateTime("LastUpdatedDate");
            }
