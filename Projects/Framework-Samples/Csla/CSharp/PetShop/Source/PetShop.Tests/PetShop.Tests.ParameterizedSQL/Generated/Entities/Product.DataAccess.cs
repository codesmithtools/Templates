...
namespace PetShop.Tests.ParameterizedSQL
{
    public partial class Product
    {
        ...
        protected override void DataPortal_Update()
        {
            ...
            const string commandText = "UPDATE [dbo].[Product]  SET [ProductId] = @p_ProductId, [CategoryId] = @p_CategoryId, [Name] = @p_Name, [Descn] = @p_Descn, [Image] = @p_Image WHERE [ProductId] = @p_OriginalProductId AND [timestamp] = @p_timestamp; SELECT [timestamp] FROM [dbo].[Product] WHERE ProductId = @p_ProductId";
            using (SqlConnection connection = new SqlConnection(ADOHelper.ConnectionString))
            {
                connection.Open();
                using(SqlCommand command = new SqlCommand(commandText, connection))
        ...
        private void Map(SafeDataReader reader)
        {
            ...
            using(BypassPropertyChecks)
            {
                ...
                LoadProperty(_originalProductIdProperty, reader.GetString("ProductId"));
