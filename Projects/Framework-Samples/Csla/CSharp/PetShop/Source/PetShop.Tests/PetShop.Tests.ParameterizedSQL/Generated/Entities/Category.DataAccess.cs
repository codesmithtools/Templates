...
namespace PetShop.Tests.ParameterizedSQL
{
    public partial class Category
    {
        ...
        protected override void DataPortal_Update()
        {
            ...
            const string commandText = "UPDATE [dbo].[Category]  SET [CategoryId] = @p_CategoryId, [Name] = @p_Name, [Descn] = @p_Descn WHERE [CategoryId] = @p_OriginalCategoryId AND [timestamp] = @p_timestamp; SELECT [timestamp] FROM [dbo].[Category] WHERE CategoryId = @p_CategoryId";
            using (SqlConnection connection = new SqlConnection(ADOHelper.ConnectionString))
            {
                connection.Open();
                using(SqlCommand command = new SqlCommand(commandText, connection))
