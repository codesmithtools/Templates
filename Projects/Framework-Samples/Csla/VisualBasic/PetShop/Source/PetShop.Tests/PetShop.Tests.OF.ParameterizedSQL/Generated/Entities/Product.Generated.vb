    ...
    Public ReadOnly Property CategoryMember() As Category
        Get
            If Not(FieldManager.FieldExists(_categoryMemberProperty))
                ...
                If (Me.IsNew Or Not PetShop.Tests.OF.ParameterizedSQL.Category.Exists(criteria)) Then
                    LoadProperty(_categoryMemberProperty, PetShop.Tests.OF.ParameterizedSQL.Category.NewCategory())
                Else
                    LoadProperty(_categoryMemberProperty, PetShop.Tests.OF.ParameterizedSQL.Category.GetByCategoryId(CategoryId))
                End If
            End If
...
Public ReadOnly Property Items() As ItemList 
        Get
            If Not (FieldManager.FieldExists(_itemsProperty)) Then
                ...
                If (Me.IsNew Or Not PetShop.Tests.OF.ParameterizedSQL.ItemList.Exists(criteria)) Then
    ...
    #End Region
        ...
        Public Overloads Overrides ReadOnly Property IsDirty() As Boolean
            Get
                ...
                If CategoryMember.IsDirty Then
                    Return True
                End If
                If Items.IsDirty Then
                    Return True
                End If
                Return False
            End Get
