...
Public ReadOnly Property LineItems() As LineItemList 
        Get
            If Not (FieldManager.FieldExists(_lineItemsProperty)) Then
                Dim criteria As New PetShop.Tests.OF.StoredProcedures.LineItemCriteria()
                criteria.OrderId = OrderId
                
                If (Me.IsNew Or Not PetShop.Tests.OF.StoredProcedures.LineItemList.Exists(criteria)) Then
                    LoadProperty(_lineItemsProperty, PetShop.Tests.OF.StoredProcedures.LineItemList.NewList())
                Else
                    LoadProperty(_lineItemsProperty, PetShop.Tests.OF.StoredProcedures.LineItemList.GetByOrderId(OrderId))
                End If
            End If
...
Public ReadOnly Property OrderStatuses() As OrderStatusList 
        Get
            If Not (FieldManager.FieldExists(_orderStatusesProperty)) Then
                Dim criteria As New PetShop.Tests.OF.StoredProcedures.OrderStatusCriteria()
                criteria.OrderId = OrderId
                
                If (Me.IsNew Or Not PetShop.Tests.OF.StoredProcedures.OrderStatusList.Exists(criteria)) Then
                    LoadProperty(_orderStatusesProperty, PetShop.Tests.OF.StoredProcedures.OrderStatusList.NewList())
                Else
                    LoadProperty(_orderStatusesProperty, PetShop.Tests.OF.StoredProcedures.OrderStatusList.GetByOrderId(OrderId))
                End If
            End If
    ...
    #End Region
        ...
        Public Overloads Overrides ReadOnly Property IsDirty() As Boolean
            Get
                ...
                If LineItems.IsDirty Then
                    Return True
                End If
                If OrderStatuses.IsDirty Then
                    Return True
                End If
                Return False
            End Get
