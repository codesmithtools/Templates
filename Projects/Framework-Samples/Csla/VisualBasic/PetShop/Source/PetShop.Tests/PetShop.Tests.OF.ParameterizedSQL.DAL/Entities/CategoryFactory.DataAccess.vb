...
Public Partial Class CategoryFactory
    ...
    Private Sub DoUpdate(ByRef item As Category, ByVal stopProccessingChildren As Boolean)
		...
		itemToUpdate.CategoryId = item.CategoryId
            ...
            Const commandText As String = "UPDATE [dbo].[Category]  SET [CategoryId] = @p_CategoryId, [Name] = @p_Name, [Descn] = @p_Descn WHERE [CategoryId] = @p_CategoryId AND [timestamp] = @p_timestamp; SELECT [timestamp] FROM [dbo].[Category] WHERE CategoryId = @p_CategoryId"
            Using connection As New SqlConnection(ADOHelper.ConnectionString)
                connection.Open()
                Using command As New SqlCommand(commandText, connection)
