...
#Region "Serialization"
        ...
        Protected Overrides Sub OnGetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            End If
            If _bag.ContainsKey("UnitPrice") Then
                info.AddValue("UnitPrice", GetValue(Of System.Decimal)("UnitPrice"))
            End If
        End Sub
        ...
        Protected Overrides Sub OnSetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            End If
            If info.Values.ContainsKey("UnitPrice") Then
                _bag("UnitPrice") = info.GetValue(Of System.Decimal)("UnitPrice")
            End If
        End Sub
