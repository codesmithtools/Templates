...
#Region "Serialization"
        ...
        Protected Overrides Sub OnGetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            End If
            If _bag.ContainsKey("Username") Then
                info.AddValue("Username", GetValue(Of System.String)("Username"))
            End If
            If _bag.ContainsKey("ApplicationName") Then
                info.AddValue("ApplicationName", GetValue(Of System.String)("ApplicationName"))
            End If
            If _bag.ContainsKey("IsAnonymous") Then
                info.AddValue("IsAnonymous", GetValue(Of System.Nullable(Of System.Boolean))("IsAnonymous"))
            End If
            If _bag.ContainsKey("LastActivityDate") Then
                info.AddValue("LastActivityDate", GetValue(Of System.Nullable(Of System.DateTime))("LastActivityDate"))
            End If
            If _bag.ContainsKey("LastUpdatedDate") Then
                info.AddValue("LastUpdatedDate", GetValue(Of System.Nullable(Of System.DateTime))("LastUpdatedDate"))
            End If
        End Sub
        ...
        Protected Overrides Sub OnSetState(ByVal info As SerializationInfo, ByVal mode As StateMode)
            ...
            End If
            If info.Values.ContainsKey("Username") Then
                _bag("Username") = info.GetValue(Of System.String)("Username")
            End If
            If info.Values.ContainsKey("ApplicationName") Then
                _bag("ApplicationName") = info.GetValue(Of System.String)("ApplicationName")
            End If
            If info.Values.ContainsKey("IsAnonymous") Then
                _bag("IsAnonymous") = info.GetValue(Of System.Nullable(Of System.Boolean))("IsAnonymous")
            End If
            If info.Values.ContainsKey("LastActivityDate") Then
                _bag("LastActivityDate") = info.GetValue(Of System.Nullable(Of System.DateTime))("LastActivityDate")
            End If
            If info.Values.ContainsKey("LastUpdatedDate") Then
                _bag("LastUpdatedDate") = info.GetValue(Of System.Nullable(Of System.DateTime))("LastUpdatedDate")
            End If
        End Sub
