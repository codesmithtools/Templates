...
#Region "Properties"
        ...
        ''' </summary>
        <NotUndoable()> _
        Friend TheVersion As System.Byte() = New System.Byte(8) {}
    ...
    Public ReadOnly Property Products() As ProductList
            Get
                If Not (FieldManager.FieldExists(_productsProperty)) Then
                    ...
                    If (Me.IsNew OrElse Not PetShop.Tests.OF.StoredProcedures.ProductList.Exists(criteria)) Then
                        LoadProperty(_productsProperty, PetShop.Tests.OF.StoredProcedures.ProductList.NewList())
                    Else
                        LoadProperty(_productsProperty, PetShop.Tests.OF.StoredProcedures.ProductList.GetByCategoryId(CategoryId))
                    End If
                End If
