...
Namespace PetShop.UI.Silverlight
    ...
    Public Class CategoryViewModel
        ...
        ''' </summary>
		Public Shared ReadOnly TestProperty As DependencyProperty = DependencyProperty.Register("Test", GetType(Object), GetType(CategoryViewModel), New PropertyMetadata(Function(o, e) Do
