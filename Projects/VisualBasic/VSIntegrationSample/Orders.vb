...
Public Class Order
    ...
    Public Sub Update()
        ...
        sql.AddParameter("@OrderId", SqlDbType.Int32, Id)
        queryParameters.Append("OrderId = @OrderId")

		sql.AddParameter("@UserId", SqlDbType.String, UserId)
		...
		sql.AddParameter("@ShipAddr1", SqlDbType.String, ShipAddr1)
        queryParameters.Append(", ShipAddr1 = @ShipAddr1")
		sql.AddParameter("@ShipAddr2", SqlDbType.String, ShipAddr2)
        queryParameters.Append(", ShipAddr2 = @ShipAddr2")
		sql.AddParameter("@ShipCity", SqlDbType.String, ShipCity)
        queryParameters.Append(", ShipCity = @ShipCity")
		sql.AddParameter("@ShipState", SqlDbType.String, ShipState)
        queryParameters.Append(", ShipState = @ShipState")
		sql.AddParameter("@ShipZip", SqlDbType.String, ShipZip)
        queryParameters.Append(", ShipZip = @ShipZip")
		sql.AddParameter("@ShipCountry", SqlDbType.String, ShipCountry)
        queryParameters.Append(", ShipCountry = @ShipCountry")
		sql.AddParameter("@BillAddr1", SqlDbType.String, BillAddr1)
        queryParameters.Append(", BillAddr1 = @BillAddr1")
		sql.AddParameter("@BillAddr2", SqlDbType.String, BillAddr2)
        queryParameters.Append(", BillAddr2 = @BillAddr2")
		sql.AddParameter("@BillCity", SqlDbType.String, BillCity)
        queryParameters.Append(", BillCity = @BillCity")
		sql.AddParameter("@BillState", SqlDbType.String, BillState)
        queryParameters.Append(", BillState = @BillState")
		sql.AddParameter("@BillZip", SqlDbType.String, BillZip)
        queryParameters.Append(", BillZip = @BillZip")
		sql.AddParameter("@BillCountry", SqlDbType.String, BillCountry)
        queryParameters.Append(", BillCountry = @BillCountry")
		sql.AddParameter("@Courier", SqlDbType.String, Courier)
		...
		sql.AddParameter("@BillToFirstName", SqlDbType.String, BillToFirstName)
        queryParameters.Append(", BillToFirstName = @BillToFirstName")
		sql.AddParameter("@BillToLastName", SqlDbType.String, BillToLastName)
        queryParameters.Append(", BillToLastName = @BillToLastName")
		sql.AddParameter("@ShipToFirstName", SqlDbType.String, ShipToFirstName)
        queryParameters.Append(", ShipToFirstName = @ShipToFirstName")
		sql.AddParameter("@ShipToLastName", SqlDbType.String, ShipToLastName)
        queryParameters.Append(", ShipToLastName = @ShipToLastName")
		sql.AddParameter("@AuthorizationNumber", SqlDbType.Int32, AuthorizationNumber)
        queryParameters.Append(", AuthorizationNumber = @AuthorizationNumber")
		sql.AddParameter("@Locale", SqlDbType.String, Locale)
