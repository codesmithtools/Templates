...
#Region "Association Mapped Properties"
        ...
        ''' </summary>
        <System.Data.Linq.Mapping.Association(Name:="Orders_OrderStatus", Storage:="_orders", ThisKey:="OrderId", OtherKey:="OrderId", IsUnique:=true, IsForeignKey:=true, DeleteOnNull:=true)> _
