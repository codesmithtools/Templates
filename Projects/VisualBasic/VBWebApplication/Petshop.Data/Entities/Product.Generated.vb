...
#Region "Association Mapped Properties"
        ...
        ''' </summary>
        <System.Data.Linq.Mapping.Association(Name:="Category_Product", Storage:="_category", ThisKey:="CategoryId", OtherKey:="CategoryId", IsUnique:=true, IsForeignKey:=true, DeleteOnNull:=true)> _
