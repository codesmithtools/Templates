...
namespace Petshop.Data
{
        ...
        : LinqEntityBase, ICloneable
    {
        ...
        static Profiles()
        {
            CodeSmith.Data.Rules.RuleManager.AddShared<Profiles>();
            AddSharedRules();
        }
        #endregion
        ...
        /// </summary>
        [System.Data.Linq.Mapping.Association(Name = "Profiles_Account", Storage = "_accountList", ThisKey = "UniqueID", OtherKey = "UniqueID")]
        ...
        /// </summary>
        [System.Data.Linq.Mapping.Association(Name = "Profiles_Cart", Storage = "_cartList", ThisKey = "UniqueID", OtherKey = "UniqueID")]
        ...
        {
            var deserializer = new System.Runtime.Serialization.DataContractSerializer(typeof(Profiles));

            using (var sr = new System.IO.StringReader(xml))
            using (var reader = System.Xml.XmlReader.Create(sr))
            {
                return deserializer.ReadObject(reader) as Profiles;
            }
        }

        /// <summary>
        /// Deserializes an instance of <see cref="Profiles"/> from a byte array.
        /// </summary>
        ...
        public static Profiles FromBinary(byte[] buffer)
        {
            var deserializer = new System.Runtime.Serialization.DataContractSerializer(typeof(Profiles));
        ...
        {
            return (Profiles)((ICloneable)this).Clone();
        }
        #endregion
