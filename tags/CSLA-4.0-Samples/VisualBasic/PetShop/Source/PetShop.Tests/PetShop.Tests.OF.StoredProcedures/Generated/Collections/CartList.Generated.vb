...
#Region "Method Overrides"
        ...
        Protected Overrides Function AddNewCore() As Cart
            Dim item As Cart = PetShop.Tests.OF.StoredProcedures.Cart.NewCart()
            ...
            If Not (cancel) Then
                ...
                If(item Is Nothing) Then
                    item = PetShop.Tests.OF.StoredProcedures.Cart.NewCart()
                End If
...
#End Region
        ...
        Protected Sub AddNewCoreAsync(ByVal handler As EventHandler(Of DataPortalResult(Of Cart)))
            PetShop.Tests.OF.StoredProcedures.Cart.NewCartAsync(Sub(o, e)
...
#Region "Exists Command"
        ...
        Public Shared Function Exists(ByVal criteria As CartCriteria) As Boolean
            Return PetShop.Tests.OF.StoredProcedures.Cart.Exists(criteria)
        End Function
        ...
        Public Shared Sub ExistsAsync(ByVal criteria As CartCriteria, ByVal handler As EventHandler(Of DataPortalResult(Of ExistsCommand)))
            PetShop.Tests.OF.StoredProcedures.Cart.ExistsAsync(criteria, handler)
        End Sub
