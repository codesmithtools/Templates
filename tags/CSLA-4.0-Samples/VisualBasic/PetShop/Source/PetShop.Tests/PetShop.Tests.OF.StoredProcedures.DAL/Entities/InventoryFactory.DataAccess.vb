...
#Region "Fetch"
        ...
        Public Function Fetch(ByVal criteria As InventoryCriteria) As Inventory
            ...
            Using connection As New SqlConnection(ADOHelper.ConnectionString)
                connection.Open()
                Using command As New SqlCommand("[dbo].[CSLA_Inventory_Select]", connection)
...
#Region "Insert"
        ...
        Private Sub DoInsert(ByRef item As Inventory, ByVal stopProccessingChildren As Boolean)
            ...
            Using connection As New SqlConnection(ADOHelper.ConnectionString)
                connection.Open()
                Using command As New SqlCommand("[dbo].[CSLA_Inventory_Insert]", connection)
                    command.CommandType = CommandType.StoredProcedure
...
#Region "Update"
        ...
        Private Sub DoUpdate(ByRef item As Inventory, ByVal stopProccessingChildren As Boolean)
            ...
            temp.Qty = item.Qty
                ...
                Using connection As New SqlConnection(ADOHelper.ConnectionString)
                    connection.Open()
                    Using command As New SqlCommand("[dbo].[CSLA_Inventory_Update]", connection)
                        command.CommandType = CommandType.StoredProcedure
...
#Region "Delete"
        ...
        Private Sub DoDelete(ByVal criteria As InventoryCriteria)
            ...
            Using connection As New SqlConnection(ADOHelper.ConnectionString)
                connection.Open()
                Using command As New SqlCommand("[dbo].[CSLA_Inventory_Delete]", connection)
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.AddRange(ADOHelper.SqlParameters(criteria.StateBag))
