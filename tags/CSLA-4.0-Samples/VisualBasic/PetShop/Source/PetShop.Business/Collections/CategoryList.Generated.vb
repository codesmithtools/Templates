...
#If Not SILVERLIGHT Then
        ...
        Protected Overrides Function AddNewCore() As Category
            Dim item As Category = PetShop.Business.Category.NewCategoryChild()
...
#Else
        ...
        Protected Overrides Sub AddNewCore() 
            PetShop.Business.Category.NewCategoryChildAsync(Sub(o, e)
...
#End If
        ...
        Public Shared Sub ExistsAsync(ByVal criteria As CategoryCriteria, ByVal handler As EventHandler(Of DataPortalResult(Of ExistsCommand)))
            PetShop.Business.Category.ExistsAsync(criteria, handler)
        End Sub
