...
namespace PetShop.Tests.StoredProcedures
{
    ...
    public class ExistsCommand : CommandBase<ExistsCommand>
    {
        ...
        public static void ExecuteAsync<T>(T criteria, EventHandler<DataPortalResult<ExistsCommand>> handler) where T : PetShop.Tests.StoredProcedures.IGeneratedCriteria
        {
            if (!CanExecuteCommand())
                throw new System.Security.SecurityException("Not authorized to execute command");
