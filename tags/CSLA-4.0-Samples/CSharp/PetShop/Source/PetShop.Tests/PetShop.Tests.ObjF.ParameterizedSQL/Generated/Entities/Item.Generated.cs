    ...
    public partial class Item : BusinessBase<Item>
    {
                ...
                if (!cancel)
                {
                    if(!FieldManager.FieldExists(_productProperty))
                    {
                        ...
                        if(PetShop.Tests.ObjF.ParameterizedSQL.Product.Exists(criteria))
                            LoadProperty(_productProperty, PetShop.Tests.ObjF.ParameterizedSQL.Product.GetByProductId(ProductId));
                    }
                }
        ...
        public override bool IsDirty
        {
            get
            {
                ...
                if (FieldManager.FieldExists(_productProperty) && Product.IsDirty) return true;
