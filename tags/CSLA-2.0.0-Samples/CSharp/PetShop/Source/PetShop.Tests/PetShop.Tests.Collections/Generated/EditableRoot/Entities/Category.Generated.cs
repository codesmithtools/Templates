...
namespace PetShop.Tests.Collections.EditableRoot
{
    ...
    public partial class Category : BusinessBase< Category >
    {
        ...
        //        {
        //            if(IsNew || !PetShop.Tests.Collections.EditableRoot.ProductList.Exists(new PetShop.Tests.Collections.EditableRoot.ProductCriteria {CategoryId = CategoryId}))
        //                LoadProperty(_productsProperty, PetShop.Tests.Collections.EditableRoot.ProductList.NewList());
        //            else
        //                LoadProperty(_productsProperty, PetShop.Tests.Collections.EditableRoot.ProductList.GetByCategoryId(CategoryId));
        //        }
