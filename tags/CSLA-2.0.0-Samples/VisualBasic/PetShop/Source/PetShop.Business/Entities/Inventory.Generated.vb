...
Public Partial Class Inventory 
    ...
    Private Shared ReadOnly _originalItemIdProperty As PropertyInfo(Of System.String) = RegisterProperty(Of System.String)(Function(p As Inventory) p.OriginalItemId)
    ''' <summary>
