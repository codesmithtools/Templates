...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class OrderCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public OrderCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Order)){}

        public OrderCriteria(System.Int32 orderId) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Order))
        {
            OrderId = orderId;
        }
