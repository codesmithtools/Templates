...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class InventoryCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public InventoryCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Inventory)){}

        public InventoryCriteria(System.String itemId) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Inventory))
        {
            ItemId = itemId;
        }
