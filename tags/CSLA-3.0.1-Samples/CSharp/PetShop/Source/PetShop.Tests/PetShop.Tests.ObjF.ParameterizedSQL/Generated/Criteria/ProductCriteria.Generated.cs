...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class ProductCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public ProductCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Product)){}

        public ProductCriteria(System.String productId) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Product))
        {
            ProductId = productId;
        }
