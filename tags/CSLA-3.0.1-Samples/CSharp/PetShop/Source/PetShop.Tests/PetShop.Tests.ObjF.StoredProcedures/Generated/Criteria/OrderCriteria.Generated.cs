...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class OrderCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public OrderCriteria() : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Order)){}

        public OrderCriteria(System.Int32 orderId) : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Order))
        {
            OrderId = orderId;
        }
