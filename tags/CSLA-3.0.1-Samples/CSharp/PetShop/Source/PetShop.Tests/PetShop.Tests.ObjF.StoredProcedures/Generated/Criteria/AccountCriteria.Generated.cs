...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class AccountCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public AccountCriteria() : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Account)){}

        public AccountCriteria(System.Int32 accountId) : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Account))
        {
            AccountId = accountId;
        }
