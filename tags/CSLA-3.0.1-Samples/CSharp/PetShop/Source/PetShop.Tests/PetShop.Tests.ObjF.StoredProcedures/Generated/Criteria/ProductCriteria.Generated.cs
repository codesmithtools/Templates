...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class ProductCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public ProductCriteria() : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Product)){}

        public ProductCriteria(System.String productId) : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Product))
        {
            ProductId = productId;
        }
