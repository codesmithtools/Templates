...
#Region "Constructors"
        ...
        Public Sub New()
        MyBase.New(GetType(PetShop.Tests.OF.StoredProcedures.Order))
        End Sub
...
#Region "Read-Only"
        ...
        Public ReadOnly Property ShipAddr2HasValue As Boolean
            Get
                Return _bag.ContainsKey("ShipAddr2")
            End Get
        End Property
    
        Public ReadOnly Property BillAddr2HasValue As Boolean
            Get
                Return _bag.ContainsKey("BillAddr2")
            End Get
        End Property
