    ...
    Protected Overrides Sub DataPortal_Insert()
        ...
        Using connection As New SqlConnection(ADOHelper.ConnectionString)
            ...
            Using command As New SqlCommand(commandText, connection)
				...
				command.Parameters.AddWithValue("@p_IsAnonymous", IIf(Me.IsAnonymous.HasValue, Me.IsAnonymous.Value, DBNull.Value))
				command.Parameters.AddWithValue("@p_LastActivityDate", IIf(Me.LastActivityDate.HasValue, Me.LastActivityDate.Value, DBNull.Value))
				command.Parameters.AddWithValue("@p_LastUpdatedDate", IIf(Me.LastUpdatedDate.HasValue, Me.LastUpdatedDate.Value, DBNull.Value))
