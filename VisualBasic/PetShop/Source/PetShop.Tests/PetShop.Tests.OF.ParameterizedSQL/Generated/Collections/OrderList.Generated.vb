...
#Region "Method Overrides"
        ...
        Protected Overrides Function AddNewCore() As Order
            Dim item As Order = PetShop.Tests.OF.ParameterizedSQL.Order.NewOrderChild()
            ...
            If Not (cancel) Then
                ...
                If(item Is Nothing) Then
                    item = PetShop.Tests.OF.ParameterizedSQL.Order.NewOrderChild()
                End If
                Add(item)
            End If
...
#End Region
        ...
        Protected Sub AddNewCoreAsync(ByVal handler As EventHandler(Of DataPortalResult(Of Order)))
            PetShop.Tests.OF.ParameterizedSQL.Order.NewOrderChildAsync(Sub(o, e)
...
#Region "Exists Command"
        ...
        Public Shared Sub ExistsAsync(ByVal criteria As OrderCriteria, ByVal handler As EventHandler(Of DataPortalResult(Of ExistsCommand)))
            PetShop.Tests.OF.ParameterizedSQL.Order.ExistsAsync(criteria, handler)
        End Sub
