...
namespace Petshop.Data
{
        ...
        : LinqEntityBase
    {
        ...
        /// </summary>
        [Association(Name="Category_Product", Storage="_category", ThisKey="CategoryId", OtherKey="CategoryId", IsUnique=true, IsForeignKey=true, DeleteOnNull=true)]
        [DataMember(Order=6, EmitDefaultValue=false)]
        public Category Category
        {
            get
            {
                if (serializing && !_category.HasLoadedOrAssignedValue)
                {
                    return null;
                }
