...
namespace Generator.CSLA
{
    ...
    public class EntityMasterCodeTemplate : QuickStartCodeTemplate
    {
        ...
        [Browsable(false)]
        public List<IEntity> CriteriaEntities = new List<IEntity>();
        [Browsable(false)]
        ...
        public TableSchemaCollection CommandObject
        {
            ...
            set
            {
                if (value != null)
                {
                    CommandObjectEntities = new EntityManager(new CSLASchemaExplorerEntityProvider(SourceDatabase, value)).Entities;
                }
            }
        }
        ...
        public TableSchemaCollection NameValueList
        {
            ...
            set
            {
                if (value != null)
                {
                    NameValueListEntities = new EntityManager(new CSLASchemaExplorerEntityProvider(SourceDatabase, value, Constants.NameValueList)).Entities;
                    OnNameListChanged();
                }
            }
        }
        ...
        public void PopulateDefaultTables()
        {
            ...
            {
                if (!Criteria.Contains(entity.SchemaName, entity.EntityKeyName))
