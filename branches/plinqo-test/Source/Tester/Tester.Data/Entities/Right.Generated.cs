...
{
    /// <summary>
    /// The class representing the dbo.Right table.
    /// </summary>
    [System.Data.Linq.Mapping.Table(Name="dbo.Right")]
        ...
        : LinqEntityBase, ICloneable
    {
        ...
        /// <summary>
        /// Initializes the <see cref="Right"/> class.
        /// </summary>
        static Right()
        {
            CodeSmith.Data.Rules.RuleManager.AddShared<Right>();
            AddSharedRules();
        }
        #endregion
        ...
        /// </summary>
        [System.Data.Linq.Mapping.Association(Name = "Right_Junction", Storage = "_junctionList", ThisKey = "Id", OtherKey = "RightId")]
        ...
        private System.Data.Linq.EntitySet<Left> _leftList;

        /// <summary>
        /// Gets or sets the Many To Many LeftList list.
        /// </summary>
        /// <value>The LeftList list.</value>
        public System.Data.Linq.EntitySet<Left> LeftList
        {
            get
            {
                if (serializing)
                ...
                if (_leftList == null)
                {
                    _leftList = new System.Data.Linq.EntitySet<Left>(OnLeftListAdd, OnLeftListRemove);
                    _leftList.SetSource(JunctionList.Select(c => c.Left));
                }
                return _leftList;
            }
            set
            {
                _leftList.Assign(value);
            }
        }

        [System.Diagnostics.DebuggerNonUserCode]
        private void OnLeftListAdd(Left entity)
        {
            SendPropertyChanging(null);
            JunctionList.Add(new Junction { Right = this, Left = entity });
            SendPropertyChanged(null);
        }

        [System.Diagnostics.DebuggerNonUserCode]
        private void OnLeftListRemove(Left entity)
        {
            SendPropertyChanging(null);
            var junction = JunctionList.FirstOrDefault(c => c.RightId == Id
                && c.LeftId == entity.Id);
        ...
        public Right Clone()
        {
            return (Right)((ICloneable)this).Clone();
        }
        #endregion
