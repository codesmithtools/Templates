...
{
    /// <summary>
    /// The manager class for Order.
    /// </summary>
    public partial class OrderManager 
        : CodeSmith.Data.EntityManagerBase<TesterDataManager, Tester.Data.Order>
    {
        /// <summary>
        /// Initializes the <see cref="OrderManager"/> class.
        /// </summary>
        static OrderManager()
        {
            AddRules();
        ...
        public OrderManager(TesterDataManager manager) : base(manager)
        {
            OnCreated();
        }
        ...
        /// </summary>
        protected System.Data.Linq.Table<Tester.Data.Order> Entity
        {
            get { return Manager.Context.Order; }
        }
        ...
        public override Tester.Data.Order GetByKey(CodeSmith.Data.IEntityKey key)
        {
        ...
        public Tester.Data.Order GetByKey(int id)
        {
            if (Context.LoadOptions == null) 
                return Query.GetByKey.Invoke(Context, id);
            else
                return Entity.FirstOrDefault(o => o.Id == id);
        }
        ...
        {
            return Entity.Delete(o => o.Id == id);
        }
