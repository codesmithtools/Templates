...
{
    /// <summary>
    /// The manager class for UserProfile.
    /// </summary>
    public partial class UserProfileManager 
        : CodeSmith.Data.EntityManagerBase<TesterDataManager, Tester.Data.UserProfile>
    {
        /// <summary>
        /// Initializes the <see cref="UserProfileManager"/> class.
        /// </summary>
        ...
        public UserProfileManager(TesterDataManager manager) : base(manager)
        {
            OnCreated();
        }
        ...
        /// </summary>
        protected System.Data.Linq.Table<Tester.Data.UserProfile> Entity
        {
            get { return Manager.Context.UserProfile; }
        }
        ...
        public override Tester.Data.UserProfile GetByKey(CodeSmith.Data.IEntityKey key)
        {
        ...
        public Tester.Data.UserProfile GetByKey(int id)
        {
        ...
        /// </summary>
        public IQueryable<Tester.Data.UserProfile> GetByUserId(int? userId)
        {
            if (Context.LoadOptions == null) 
        ...
        private static partial class Query
        {
            ...
            internal static readonly Func<Tester.Data.TesterDataContext, int?, IQueryable<Tester.Data.UserProfile>> GetByUserId = 
                System.Data.Linq.CompiledQuery.Compile(
                    (Tester.Data.TesterDataContext db, int? userId) => 
                        db.UserProfile.Where(u => u.UserId == userId));
