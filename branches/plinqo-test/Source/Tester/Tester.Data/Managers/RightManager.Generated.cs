...
{
    /// <summary>
    /// The manager class for Right.
    /// </summary>
    public partial class RightManager 
        : CodeSmith.Data.EntityManagerBase<TesterDataManager, Tester.Data.Right>
    {
        /// <summary>
        /// Initializes the <see cref="RightManager"/> class.
        /// </summary>
        static RightManager()
        {
            AddRules();
        ...
        public RightManager(TesterDataManager manager) : base(manager)
        {
            OnCreated();
        }
        ...
        /// </summary>
        protected System.Data.Linq.Table<Tester.Data.Right> Entity
        {
            get { return Manager.Context.Right; }
        }
        ...
        public override Tester.Data.Right GetByKey(CodeSmith.Data.IEntityKey key)
        {
        ...
        public Tester.Data.Right GetByKey(int id)
        {
