...
namespace CodeSmith.SchemaHelper
{
    ...
    public static class EntityExtensions
    {
        ...
        //        {
        //            if (member.ColumnName.EndsWith(memberName, true, CultureInfo.InvariantCulture))
        //                return string.Format("{0}{1}", Configuration.Instance.SearchCriteriaProperty.Prefix,
        //                                     NamingConventions.PropertyName(member.ColumnName));

        //            foreach (SearchCriteria sc in member.ListSearchCriteria)
        //            {
        ...
        //    string propertyName = NamingConventions.PropertyName(columnName);
            ...
            //foreach (Association association in entity.AssociatedForeignKeys)
            //{
            //    if (association.ClassName == className)
            //    {
