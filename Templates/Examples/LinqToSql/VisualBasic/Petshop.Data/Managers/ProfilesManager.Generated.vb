...
Namespace Petshop.Data.Managers
	...
	Inherits EntityManagerBase(Of PetshopDataManager,Profiles)
        ...
        ''' </summary>
        Shared Sub New()
            RuleManager.AddShared(Of Profiles)(new RequiredRule("Username"))
            RuleManager.AddShared(Of Profiles)(new LengthRule("Username", 256))
            RuleManager.AddShared(Of Profiles)(new RequiredRule("ApplicationName"))
            RuleManager.AddShared(Of Profiles)(new LengthRule("ApplicationName", 256))
            AddRules()
        End Sub
