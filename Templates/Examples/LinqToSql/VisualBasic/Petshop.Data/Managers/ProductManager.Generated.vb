...
Namespace Petshop.Data.Managers
	...
	Inherits EntityManagerBase(Of PetshopDataManager,Product)
        ...
        ''' </summary>
        Shared Sub New()
            RuleManager.AddShared(Of Product)(new RequiredRule("ProductId"))
            RuleManager.AddShared(Of Product)(new LengthRule("ProductId", 10))
            RuleManager.AddShared(Of Product)(new RequiredRule("CategoryId"))
            RuleManager.AddShared(Of Product)(new LengthRule("CategoryId", 10))
            RuleManager.AddShared(Of Product)(new LengthRule("Name", 80))
            RuleManager.AddShared(Of Product)(new LengthRule("Descn", 255))
            RuleManager.AddShared(Of Product)(new LengthRule("Image", 80))
            AddRules()
        End Sub
