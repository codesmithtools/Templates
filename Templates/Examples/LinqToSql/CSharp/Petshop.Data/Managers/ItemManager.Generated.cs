...
namespace Petshop.Data.Managers
{
    ...
    public partial class ItemManager : EntityManagerBase<PetshopDataManager, Item>
    {
        ...
        static ItemManager()
        {
            RuleManager.AddShared<Item>(new RequiredRule("ItemId"));
            RuleManager.AddShared<Item>(new LengthRule("ItemId", 10));
            RuleManager.AddShared<Item>(new RequiredRule("ProductId"));
            RuleManager.AddShared<Item>(new LengthRule("ProductId", 10));
            RuleManager.AddShared<Item>(new LengthRule("Status", 2));
            RuleManager.AddShared<Item>(new LengthRule("Name", 80));
            RuleManager.AddShared<Item>(new LengthRule("Image", 80));
            AddRules();
        }
