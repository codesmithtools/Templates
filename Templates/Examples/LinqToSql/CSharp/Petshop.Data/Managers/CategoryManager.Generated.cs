...
namespace Petshop.Data.Managers
{
    ...
    public partial class CategoryManager : EntityManagerBase<PetshopDataManager, Category>
    {
        ...
        {
            RuleManager.AddShared<Category>(new RequiredRule("CategoryId"));
            RuleManager.AddShared<Category>(new LengthRule("CategoryId", 10));
            RuleManager.AddShared<Category>(new LengthRule("Name", 80));
            RuleManager.AddShared<Category>(new LengthRule("Descn", 255));
            AddRules();
        }
