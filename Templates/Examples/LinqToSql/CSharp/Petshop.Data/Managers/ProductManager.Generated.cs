...
namespace Petshop.Data.Managers
{
    ...
    public partial class ProductManager : EntityManagerBase<PetshopDataManager, Product>
    {
        ...
        {
            RuleManager.AddShared<Product>(new RequiredRule("ProductId"));
            RuleManager.AddShared<Product>(new LengthRule("ProductId", 10));
            RuleManager.AddShared<Product>(new RequiredRule("CategoryId"));
            RuleManager.AddShared<Product>(new LengthRule("CategoryId", 10));
            RuleManager.AddShared<Product>(new LengthRule("Name", 80));
            RuleManager.AddShared<Product>(new LengthRule("Descn", 255));
            RuleManager.AddShared<Product>(new LengthRule("Image", 80));
            AddRules();
        }
