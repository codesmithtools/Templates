...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class OrderStatusCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public OrderStatusCriteria() : base(typeof(PetShop.Tests.ObjF.StoredProcedures.OrderStatus)){}

        public OrderStatusCriteria(System.Int32 orderId, System.Int32 lineNum) : base(typeof(PetShop.Tests.ObjF.StoredProcedures.OrderStatus))
        {
            OrderId = orderId;
            LineNum = lineNum;
        }
