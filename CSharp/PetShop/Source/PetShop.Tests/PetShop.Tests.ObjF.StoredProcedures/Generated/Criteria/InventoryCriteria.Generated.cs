...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class InventoryCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public InventoryCriteria() : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Inventory)){}

        public InventoryCriteria(System.String itemId) : base(typeof(PetShop.Tests.ObjF.StoredProcedures.Inventory))
        {
            ItemId = itemId;
        }
