...
namespace PetShop.Tests.ObjF.StoredProcedures
{
    ...
    public partial class LineItemCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public LineItemCriteria() : base(typeof(PetShop.Tests.ObjF.StoredProcedures.LineItem)){}

        public LineItemCriteria(System.Int32 orderId, System.Int32 lineNum) : base(typeof(PetShop.Tests.ObjF.StoredProcedures.LineItem))
        {
            OrderId = orderId;
            LineNum = lineNum;
        }
