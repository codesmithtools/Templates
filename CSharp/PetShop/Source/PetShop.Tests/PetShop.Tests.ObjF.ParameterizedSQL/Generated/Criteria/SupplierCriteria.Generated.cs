...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class SupplierCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public SupplierCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Supplier)){}

        public SupplierCriteria(System.Int32 suppId) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Supplier))
        {
            SuppId = suppId;
        }
