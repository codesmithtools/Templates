...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class CartCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public CartCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Cart)){}

        public CartCriteria(System.Int32 cartId) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.Cart))
        {
            CartId = cartId;
        }
