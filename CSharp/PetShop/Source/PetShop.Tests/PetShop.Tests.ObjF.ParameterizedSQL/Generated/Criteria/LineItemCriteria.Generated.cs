...
namespace PetShop.Tests.ObjF.ParameterizedSQL
{
    ...
    public partial class LineItemCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public LineItemCriteria() : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.LineItem)){}

        public LineItemCriteria(System.Int32 orderId, System.Int32 lineNum) : base(typeof(PetShop.Tests.ObjF.ParameterizedSQL.LineItem))
        {
            OrderId = orderId;
            LineNum = lineNum;
        }
