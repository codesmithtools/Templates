...
namespace PetShop.Tests.Collections.DynamicRoot
{
    ...
    public partial class CategoryCriteria : CriteriaBase, IGeneratedCriteria
    {
        ...
        public CategoryCriteria() : base(typeof(PetShop.Tests.Collections.DynamicRoot.Category)){}

        public CategoryCriteria(System.String categoryId) : base(typeof(PetShop.Tests.Collections.DynamicRoot.Category))
        {
