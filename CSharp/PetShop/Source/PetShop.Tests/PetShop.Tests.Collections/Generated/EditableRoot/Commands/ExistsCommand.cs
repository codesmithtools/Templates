...
namespace PetShop.Tests.Collections.EditableRoot
{
    ...
    public class ExistsCommand : CommandBase<ExistsCommand>
    {
        ...
        private PetShop.Tests.Collections.EditableRoot.IGeneratedCriteria Criteria { get; set; }
        public bool Result { get; private set; }

        private void BeforeServer(PetShop.Tests.Collections.EditableRoot.IGeneratedCriteria criteria)
        {
            Criteria = criteria;
            Result = false;
        }
        ...
        public static bool Execute<T>(T criteria) where T : PetShop.Tests.Collections.EditableRoot.IGeneratedCriteria
        {
        ...
        public static void ExecuteAsync<T>(T criteria, EventHandler<DataPortalResult<ExistsCommand>> handler) where T : PetShop.Tests.Collections.EditableRoot.IGeneratedCriteria
        {
            if (!CanExecuteCommand())
                throw new System.Security.SecurityException("Not authorized to execute command");
